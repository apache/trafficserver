...
#line argument
#
#To compare records config between two versions of ATS, obtain output of command
#"traffic_ctl config proxy" from different ATS versions and save them to two
#different files
#
...
sub usage
{
  ...
  print "compare_records.pl -m -f <filename1> -f <filename2>\n";
