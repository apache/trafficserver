...
/* ------------------------------------------------------------------- */
  ...
  inline FilePath::operator const char* () const { return _path; }
  inline char const* FilePath::path() const { return _path; }

  inline bool FilePath::has_path() const { return _path && 0 != _path[0]; }
  inline bool FilePath::is_absolute() const { return _path && '/' == _path[0]; }
  inline bool FilePath::is_relative() const { return !this->is_absolute(); }

  inline struct stat const* FilePath::stat() const
  {
    if (!_stat_p) _stat_p = ::stat(_path, &_stat) >= 0;
  ...
  inline int FilePath::file_type() const { return this->stat() ? (_stat.st_mode & S_IFMT) : 0; }

  inline bool FilePath::is_dir() const { return this->file_type() == S_IFDIR; }
  inline bool FilePath::is_char_device() const { return this->file_type() == S_IFCHR; }
  inline bool FilePath::is_block_device() const { return this->file_type() == S_IFBLK; }
  inline bool FilePath::is_regular_file() const { return this->file_type() == S_IFREG; }
