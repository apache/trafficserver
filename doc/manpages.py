...
man_pages = [
    ...
    ('admin-guide/files/cache.yaml.en', 'cache.yaml', u'Traffic Server cache configuration file', None, '5'),
    ...
    ('admin-guide/files/records.yaml.en', 'records.yaml', u'Traffic Server configuration file', None, '5'),
