...
.. ts:cv:: CONFIG proxy.config.url_remap.acl_behavior_policy INT 0
   ...
   This controls how ACL filter actions behave in :file:`remap.config`. See :ref:`acl-filters` for more details.
...
.. note::
   ...
   like this configuration is set to ``1`` (modern) and the configuration will be removed entirely.
