...
man_pages = [
    ...
    # pages
    ('developer-guide/api/functions/' + filename[:-4], filename.split('.', 1)[0], filename.split('.', 1)[0] + ' API function', None, '3ts') for filename in os.listdir('{}/developer-guide/api/functions/'.format(srcdir)) if filename != 'index.en.rst' and filename.endswith('.rst')] + [
