...
using the 'plss' log field. If empty, does not change the current setter value.
...
for debugging and logging purposes. If provided, it's equivalent to calling
:func:`TSHttpStatusSetterSet` with the same value.
