...
Get the current parent selection key URL, also referred to as the parent selection URL. This must
...
.. c:function:: TSReturnCode TSHttpTxnCacheParentSelectionUrlSet(TSHttpTxn txnp, TSMBuffer bufp, TSMLoc offset)

Description
-----------

Set the current parent selection key URL, also referred to as the parent selection URL. This must
be stored in a properly allocated URL object, typically created with a
