...
:enumerator:`TS_PARSE_ERROR` indicates an error. Success is indicated by one of
:enumerator:`TS_PARSE_DONE` or :enumerator:`TS_PARSE_CONT`. The other APIs all return
a :enum:`TSReturnCode`, indicating success (:enumerator:`TS_SUCCESS`) or failure
