...
/**
 * @file Cleanup.h
 * @brief Easy-to-use utilities to avoid resource leaks or double-releases of resources.
 */
...
namespace tsapi
{
// This sub-namespace is for declarations specifically designed to work with declarations in tsapi::c.
//
namespace c_support
{
