...
struct HttpStatsBlock {
  ...
  Counter::AtomicType *background_fill_bytes_aborted;
  Counter::AtomicType *background_fill_bytes_completed;
  Counter::AtomicType *background_fill_current_count;
  Counter::AtomicType *background_fill_total_count;
  Counter::AtomicType *broken_server_connections;
  Counter::AtomicType *cache_deletes;
  Counter::AtomicType *cache_hit_fresh;
  Counter::AtomicType *cache_hit_ims;
  Counter::AtomicType *cache_hit_mem_fresh;
  Counter::AtomicType *cache_hit_reval;
  Counter::AtomicType *cache_hit_rww;
  Counter::AtomicType *cache_hit_stale_served;
  Counter::AtomicType *cache_lookups;
  Counter::AtomicType *cache_miss_changed;
  Counter::AtomicType *cache_miss_client_no_cache;
  Counter::AtomicType *cache_miss_cold;
  Counter::AtomicType *cache_miss_ims;
  Counter::AtomicType *cache_miss_uncacheable;
  Counter::AtomicType *cache_open_read_begin_time;
  Counter::AtomicType *cache_open_read_end_time;
  Counter::AtomicType *cache_open_write_adjust_thread;
  Counter::AtomicType *cache_open_write_begin_time;
  Counter::AtomicType *cache_open_write_end_time;
  Counter::AtomicType *cache_read_error;
  Counter::AtomicType *cache_read_errors;
  Counter::AtomicType *cache_updates;
  Counter::AtomicType *cache_write_errors;
  Counter::AtomicType *cache_writes;
  Counter::AtomicType *completed_requests;
  Counter::AtomicType *connect_requests;
  Counter::AtomicType *current_active_client_connections;
  Counter::AtomicType *current_cache_connections;
  Counter::AtomicType *current_client_connections;
  Counter::AtomicType *current_client_transactions;
  Counter::AtomicType *current_parent_proxy_connections;
  Counter::AtomicType *current_server_connections;
  Counter::AtomicType *current_server_transactions;
  Counter::AtomicType *delete_requests;
  Counter::AtomicType *disallowed_post_100_continue;
  Counter::AtomicType *dns_lookup_begin_time;
  Counter::AtomicType *dns_lookup_end_time;
  Counter::AtomicType *down_server_no_requests;
  Counter::AtomicType *err_client_abort_count;
  Counter::AtomicType *err_client_abort_origin_server_bytes;
  Counter::AtomicType *err_client_abort_user_agent_bytes;
  Counter::AtomicType *err_client_read_error_count;
  Counter::AtomicType *err_client_read_error_origin_server_bytes;
  Counter::AtomicType *err_client_read_error_user_agent_bytes;
  Counter::AtomicType *err_connect_fail_count;
  Counter::AtomicType *err_connect_fail_origin_server_bytes;
  Counter::AtomicType *err_connect_fail_user_agent_bytes;
  Counter::AtomicType *extension_method_requests;
  Counter::AtomicType *get_requests;
  Counter::AtomicType *head_requests;
  Counter::AtomicType *https_incoming_requests;
  Counter::AtomicType *https_total_client_connections;
  Counter::AtomicType *incoming_requests;
  Counter::AtomicType *incoming_responses;
  Counter::AtomicType *invalid_client_requests;
  Counter::AtomicType *misc_count;
  Counter::AtomicType *misc_origin_server_bytes;
  Counter::AtomicType *misc_user_agent_bytes;
  Counter::AtomicType *missing_host_hdr;
  Counter::AtomicType *options_requests;
  Counter::AtomicType *origin_body;
  Counter::AtomicType *origin_close_private;
  Counter::AtomicType *origin_connect_adjust_thread;
  Counter::AtomicType *origin_connections_throttled;
  Counter::AtomicType *origin_make_new;
  Counter::AtomicType *origin_no_sharing;
  Counter::AtomicType *origin_not_found;
  Counter::AtomicType *origin_private;
  Counter::AtomicType *origin_raw;
  Counter::AtomicType *origin_reuse;
  Counter::AtomicType *origin_reuse_fail;
  Counter::AtomicType *origin_server_request_document_total_size;
  Counter::AtomicType *origin_server_request_header_total_size;
  Counter::AtomicType *origin_server_response_document_total_size;
  Counter::AtomicType *origin_server_response_header_total_size;
  Counter::AtomicType *origin_shutdown_cleanup_entry;
  Counter::AtomicType *origin_shutdown_migration_failure;
  Counter::AtomicType *origin_shutdown_pool_lock_contention;
  Counter::AtomicType *origin_shutdown_release_invalid_request;
  Counter::AtomicType *origin_shutdown_release_invalid_response;
  Counter::AtomicType *origin_shutdown_release_misc;
  Counter::AtomicType *origin_shutdown_release_modified;
  Counter::AtomicType *origin_shutdown_release_no_keep_alive;
  Counter::AtomicType *origin_shutdown_release_no_server;
  Counter::AtomicType *origin_shutdown_release_no_sharing;
  Counter::AtomicType *origin_shutdown_tunnel_abort;
  Counter::AtomicType *origin_shutdown_tunnel_client;
  Counter::AtomicType *origin_shutdown_tunnel_server;
  Counter::AtomicType *origin_shutdown_tunnel_server_detach;
  Counter::AtomicType *origin_shutdown_tunnel_server_eos;
  Counter::AtomicType *origin_shutdown_tunnel_server_no_keep_alive;
  Counter::AtomicType *origin_shutdown_tunnel_server_plugin_tunnel;
  Counter::AtomicType *origin_shutdown_tunnel_transform_read;
  Counter::AtomicType *outgoing_requests;
  Counter::AtomicType *parent_count;
  Counter::AtomicType *parent_proxy_request_total_bytes;
  Counter::AtomicType *parent_proxy_response_total_bytes;
  Counter::AtomicType *parent_proxy_transaction_time;
  Counter::AtomicType *pooled_server_connections;
  Counter::AtomicType *post_body_too_large;
  Counter::AtomicType *post_requests;
  Counter::AtomicType *proxy_loop_detected;
  Counter::AtomicType *proxy_mh_loop_detected;
  Counter::AtomicType *purge_requests;
  Counter::AtomicType *push_requests;
  Counter::AtomicType *pushed_document_total_size;
  Counter::AtomicType *pushed_response_header_total_size;
  Counter::AtomicType *put_requests;
  Counter::AtomicType *response_status_100_count;
  Counter::AtomicType *response_status_101_count;
  Counter::AtomicType *response_status_1xx_count;
  Counter::AtomicType *response_status_200_count;
  Counter::AtomicType *response_status_201_count;
  Counter::AtomicType *response_status_202_count;
  Counter::AtomicType *response_status_203_count;
  Counter::AtomicType *response_status_204_count;
  Counter::AtomicType *response_status_205_count;
  Counter::AtomicType *response_status_206_count;
  Counter::AtomicType *response_status_2xx_count;
  Counter::AtomicType *response_status_300_count;
  Counter::AtomicType *response_status_301_count;
  Counter::AtomicType *response_status_302_count;
  Counter::AtomicType *response_status_303_count;
  Counter::AtomicType *response_status_304_count;
  Counter::AtomicType *response_status_305_count;
  Counter::AtomicType *response_status_307_count;
  Counter::AtomicType *response_status_308_count;
  Counter::AtomicType *response_status_3xx_count;
  Counter::AtomicType *response_status_400_count;
  Counter::AtomicType *response_status_401_count;
  Counter::AtomicType *response_status_402_count;
  Counter::AtomicType *response_status_403_count;
  Counter::AtomicType *response_status_404_count;
  Counter::AtomicType *response_status_405_count;
  Counter::AtomicType *response_status_406_count;
  Counter::AtomicType *response_status_407_count;
  Counter::AtomicType *response_status_408_count;
  Counter::AtomicType *response_status_409_count;
  Counter::AtomicType *response_status_410_count;
  Counter::AtomicType *response_status_411_count;
  Counter::AtomicType *response_status_412_count;
  Counter::AtomicType *response_status_413_count;
  Counter::AtomicType *response_status_414_count;
  Counter::AtomicType *response_status_415_count;
  Counter::AtomicType *response_status_416_count;
  Counter::AtomicType *response_status_4xx_count;
  Counter::AtomicType *response_status_500_count;
  Counter::AtomicType *response_status_501_count;
  Counter::AtomicType *response_status_502_count;
  Counter::AtomicType *response_status_503_count;
  Counter::AtomicType *response_status_504_count;
  Counter::AtomicType *response_status_505_count;
  Counter::AtomicType *response_status_5xx_count;
  Counter::AtomicType *server_begin_write_time;
  Counter::AtomicType *server_close_time;
  Counter::AtomicType *server_connect_end_time;
  Counter::AtomicType *server_connect_time;
  Counter::AtomicType *server_first_connect_time;
  Counter::AtomicType *server_first_read_time;
  Counter::AtomicType *server_read_header_done_time;
  Counter::AtomicType *sm_finish_time;
  Counter::AtomicType *sm_start_time;
  Counter::AtomicType *tcp_client_refresh_count;
  Counter::AtomicType *tcp_client_refresh_origin_server_bytes;
  Counter::AtomicType *tcp_client_refresh_user_agent_bytes;
  Counter::AtomicType *tcp_expired_miss_count;
  Counter::AtomicType *tcp_expired_miss_origin_server_bytes;
  Counter::AtomicType *tcp_expired_miss_user_agent_bytes;
  Counter::AtomicType *tcp_hit_count;
  Counter::AtomicType *tcp_hit_origin_server_bytes;
  Counter::AtomicType *tcp_hit_user_agent_bytes;
  Counter::AtomicType *tcp_ims_hit_count;
  Counter::AtomicType *tcp_ims_hit_origin_server_bytes;
  Counter::AtomicType *tcp_ims_hit_user_agent_bytes;
  Counter::AtomicType *tcp_ims_miss_count;
  Counter::AtomicType *tcp_ims_miss_origin_server_bytes;
  Counter::AtomicType *tcp_ims_miss_user_agent_bytes;
  Counter::AtomicType *tcp_miss_count;
  Counter::AtomicType *tcp_miss_origin_server_bytes;
  Counter::AtomicType *tcp_miss_user_agent_bytes;
  Counter::AtomicType *tcp_refresh_hit_count;
  Counter::AtomicType *tcp_refresh_hit_origin_server_bytes;
  Counter::AtomicType *tcp_refresh_hit_user_agent_bytes;
  Counter::AtomicType *tcp_refresh_miss_count;
  Counter::AtomicType *tcp_refresh_miss_origin_server_bytes;
  Counter::AtomicType *tcp_refresh_miss_user_agent_bytes;
  Counter::AtomicType *total_client_connections;
  Counter::AtomicType *total_client_connections_ipv4;
  Counter::AtomicType *total_client_connections_ipv6;
  Counter::AtomicType *total_incoming_connections;
  Counter::AtomicType *total_parent_marked_down_count;
  Counter::AtomicType *total_parent_proxy_connections;
  Counter::AtomicType *total_parent_retries;
  Counter::AtomicType *total_parent_retries_exhausted;
  Counter::AtomicType *total_parent_switches;
  Counter::AtomicType *total_server_connections;
  Counter::AtomicType *total_transactions_time;
  Counter::AtomicType *total_x_redirect;
  Counter::AtomicType *trace_requests;
  Counter::AtomicType *tunnel_current_active_connections;
  Counter::AtomicType *tunnels;
  Counter::AtomicType *ua_begin_time;
  Counter::AtomicType *ua_begin_write_time;
  Counter::AtomicType *ua_close_time;
  Counter::AtomicType *ua_counts_errors_aborts;
  Counter::AtomicType *ua_counts_errors_connect_failed;
  Counter::AtomicType *ua_counts_errors_other;
  Counter::AtomicType *ua_counts_errors_possible_aborts;
  Counter::AtomicType *ua_counts_errors_pre_accept_hangups;
  Counter::AtomicType *ua_counts_hit_fresh;
  Counter::AtomicType *ua_counts_hit_fresh_process;
  Counter::AtomicType *ua_counts_hit_reval;
  Counter::AtomicType *ua_counts_miss_changed;
  Counter::AtomicType *ua_counts_miss_client_no_cache;
  Counter::AtomicType *ua_counts_miss_cold;
  Counter::AtomicType *ua_counts_miss_uncacheable;
  Counter::AtomicType *ua_counts_other_unclassified;
  Counter::AtomicType *ua_first_read_time;
  Counter::AtomicType *ua_msecs_errors_aborts;
  Counter::AtomicType *ua_msecs_errors_connect_failed;
  Counter::AtomicType *ua_msecs_errors_other;
  Counter::AtomicType *ua_msecs_errors_possible_aborts;
  Counter::AtomicType *ua_msecs_errors_pre_accept_hangups;
  Counter::AtomicType *ua_msecs_hit_fresh;
  Counter::AtomicType *ua_msecs_hit_fresh_process;
  Counter::AtomicType *ua_msecs_hit_reval;
  Counter::AtomicType *ua_msecs_miss_changed;
  Counter::AtomicType *ua_msecs_miss_client_no_cache;
  Counter::AtomicType *ua_msecs_miss_cold;
  Counter::AtomicType *ua_msecs_miss_uncacheable;
  Counter::AtomicType *ua_msecs_other_unclassified;
  Counter::AtomicType *ua_read_header_done_time;
  Counter::AtomicType *user_agent_request_document_total_size;
  Counter::AtomicType *user_agent_request_header_total_size;
  Counter::AtomicType *user_agent_response_document_total_size;
  Counter::AtomicType *user_agent_response_header_total_size;
  Counter::AtomicType *websocket_current_active_client_connections;
};
