...
Http2::init()
{
  RecEstablishStaticConfigInt32U(max_concurrent_streams_in, "proxy.config.http2.max_concurrent_streams_in");
  RecEstablishStaticConfigInt32U(min_concurrent_streams_in, "proxy.config.http2.min_concurrent_streams_in");
  RecEstablishStaticConfigInt32U(max_concurrent_streams_out, "proxy.config.http2.max_concurrent_streams_out");
  RecEstablishStaticConfigInt32U(min_concurrent_streams_out, "proxy.config.http2.min_concurrent_streams_out");

  RecEstablishStaticConfigInt32U(max_active_streams_in, "proxy.config.http2.max_active_streams_in");
  RecEstablishStaticConfigInt32U(stream_priority_enabled, "proxy.config.http2.stream_priority_enabled");

  RecEstablishStaticConfigInt32U(initial_window_size_in, "proxy.config.http2.initial_window_size_in");
  uint32_t flow_control_policy_in_int = 0;
  RecEstablishStaticConfigInt32U(flow_control_policy_in_int, "proxy.config.http2.flow_control.policy_in");
  ...
  RecEstablishStaticConfigInt32U(initial_window_size_out, "proxy.config.http2.initial_window_size_out");
  uint32_t flow_control_policy_out_int = 0;
  RecEstablishStaticConfigInt32U(flow_control_policy_out_int, "proxy.config.http2.flow_control.policy_out");
  ...
  RecEstablishStaticConfigInt32U(max_frame_size, "proxy.config.http2.max_frame_size");
  RecEstablishStaticConfigInt32U(header_table_size, "proxy.config.http2.header_table_size");
  RecEstablishStaticConfigInt32U(max_header_list_size, "proxy.config.http2.max_header_list_size");
  RecEstablishStaticConfigInt32U(accept_no_activity_timeout, "proxy.config.http2.accept_no_activity_timeout");
  RecEstablishStaticConfigInt32U(no_activity_timeout_in, "proxy.config.http2.no_activity_timeout_in");
  RecEstablishStaticConfigInt32U(no_activity_timeout_out, "proxy.config.http2.no_activity_timeout_out");
  RecEstablishStaticConfigInt32U(active_timeout_in, "proxy.config.http2.active_timeout_in");
  RecEstablishStaticConfigInt32U(incomplete_header_timeout_in, "proxy.config.http2.incomplete_header_timeout_in");
  RecEstablishStaticConfigInt32U(push_diary_size, "proxy.config.http2.push_diary_size");
  RecEstablishStaticConfigInt32U(zombie_timeout_in, "proxy.config.http2.zombie_debug_timeout_in");
  RecEstablishStaticConfigFloat(stream_error_rate_threshold, "proxy.config.http2.stream_error_rate_threshold");
  RecEstablishStaticConfigInt32U(stream_error_sampling_threshold, "proxy.config.http2.stream_error_sampling_threshold");
  ...
  RecEstablishStaticConfigInt32U(con_slow_log_threshold, "proxy.config.http2.connection.slow.log.threshold");
  RecEstablishStaticConfigInt32U(stream_slow_log_threshold, "proxy.config.http2.stream.slow.log.threshold");
  RecEstablishStaticConfigInt32U(header_table_size_limit, "proxy.config.http2.header_table_size_limit");
  RecEstablishStaticConfigInt32U(write_buffer_block_size, "proxy.config.http2.write_buffer_block_size");
  RecEstablishStaticConfigFloat(write_size_threshold, "proxy.config.http2.write_size_threshold");
  RecEstablishStaticConfigInt32U(write_time_threshold, "proxy.config.http2.write_time_threshold");
  RecEstablishStaticConfigInt32U(buffer_water_mark, "proxy.config.http2.default_buffer_water_mark");
