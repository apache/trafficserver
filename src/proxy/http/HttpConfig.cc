...
register_stat_callbacks()
{
  ...
  http_rsb.background_fill_bytes_aborted        = metrics.createPtr("proxy.process.http.background_fill_bytes_aborted");
  http_rsb.background_fill_bytes_completed      = metrics.createPtr("proxy.process.http.background_fill_bytes_completed");
  http_rsb.background_fill_current_count        = metrics.createPtr("proxy.process.http.background_fill_current_count");
  http_rsb.background_fill_total_count          = metrics.createPtr("proxy.process.http.background_fill_total_count");
  http_rsb.broken_server_connections            = metrics.createPtr("proxy.process.http.broken_server_connections");
  http_rsb.cache_deletes                        = metrics.createPtr("proxy.process.http.cache_deletes");
  http_rsb.cache_hit_fresh                      = metrics.createPtr("proxy.process.http.cache_hit_fresh");
  http_rsb.cache_hit_ims                        = metrics.createPtr("proxy.process.http.cache_hit_ims");
  http_rsb.cache_hit_mem_fresh                  = metrics.createPtr("proxy.process.http.cache_hit_mem_fresh");
  http_rsb.cache_hit_reval                      = metrics.createPtr("proxy.process.http.cache_hit_revalidated");
  http_rsb.cache_hit_rww                        = metrics.createPtr("proxy.process.http.cache_hit_rww");
  http_rsb.cache_hit_stale_served               = metrics.createPtr("proxy.process.http.cache_hit_stale_served");
  http_rsb.cache_lookups                        = metrics.createPtr("proxy.process.http.cache_lookups");
  http_rsb.cache_miss_changed                   = metrics.createPtr("proxy.process.http.cache_miss_changed");
  http_rsb.cache_miss_client_no_cache           = metrics.createPtr("proxy.process.http.cache_miss_client_no_cache");
  http_rsb.cache_miss_cold                      = metrics.createPtr("proxy.process.http.cache_miss_cold");
  http_rsb.cache_miss_ims                       = metrics.createPtr("proxy.process.http.cache_miss_ims");
  http_rsb.cache_miss_uncacheable               = metrics.createPtr("proxy.process.http.cache_miss_client_not_cacheable");
  http_rsb.cache_open_read_begin_time           = metrics.createPtr("proxy.process.http.milestone.cache_open_read_begin");
  http_rsb.cache_open_read_end_time             = metrics.createPtr("proxy.process.http.milestone.cache_open_read_end");
  http_rsb.cache_open_write_adjust_thread       = metrics.createPtr("proxy.process.http.cache.open_write.adjust_thread");
  http_rsb.cache_open_write_begin_time          = metrics.createPtr("proxy.process.http.milestone.cache_open_write_begin");
  http_rsb.cache_open_write_end_time            = metrics.createPtr("proxy.process.http.milestone.cache_open_write_end");
  http_rsb.cache_read_error                     = metrics.createPtr("proxy.process.http.cache_read_error");
  http_rsb.cache_read_errors                    = metrics.createPtr("proxy.process.http.cache_read_errors");
  http_rsb.cache_updates                        = metrics.createPtr("proxy.process.http.cache_updates");
  http_rsb.cache_write_errors                   = metrics.createPtr("proxy.process.http.cache_write_errors");
  http_rsb.cache_writes                         = metrics.createPtr("proxy.process.http.cache_writes");
  http_rsb.completed_requests                   = metrics.createPtr("proxy.process.http.completed_requests");
  http_rsb.connect_requests                     = metrics.createPtr("proxy.process.http.connect_requests");
  http_rsb.current_active_client_connections    = metrics.createPtr("proxy.process.http.current_active_client_connections");
  http_rsb.current_cache_connections            = metrics.createPtr("proxy.process.http.current_cache_connections");
  http_rsb.current_client_connections           = metrics.createPtr("proxy.process.http.current_client_connections");
  http_rsb.current_client_transactions          = metrics.createPtr("proxy.process.http.current_client_transactions");
  http_rsb.current_parent_proxy_connections     = metrics.createPtr("proxy.process.http.current_parent_proxy_connections");
  http_rsb.current_server_connections           = metrics.createPtr("proxy.process.http.current_server_connections");
  http_rsb.current_server_transactions          = metrics.createPtr("proxy.process.http.current_server_transactions");
  http_rsb.delete_requests                      = metrics.createPtr("proxy.process.http.delete_requests");
  http_rsb.disallowed_post_100_continue         = metrics.createPtr("proxy.process.http.disallowed_post_100_continue");
  http_rsb.dns_lookup_begin_time                = metrics.createPtr("proxy.process.http.milestone.dns_lookup_begin");
  http_rsb.dns_lookup_end_time                  = metrics.createPtr("proxy.process.http.milestone.dns_lookup_end");
  http_rsb.down_server_no_requests              = metrics.createPtr("proxy.process.http.down_server.no_requests");
  http_rsb.err_client_abort_count               = metrics.createPtr("proxy.process.http.err_client_abort_count");
  http_rsb.err_client_abort_origin_server_bytes = metrics.createPtr("proxy.process.http.err_client_abort_origin_server_bytes");
  http_rsb.err_client_abort_user_agent_bytes    = metrics.createPtr("proxy.process.http.err_client_abort_user_agent_bytes");
  http_rsb.err_client_read_error_count          = metrics.createPtr("proxy.process.http.err_client_read_error_count");
  http_rsb.err_client_read_error_origin_server_bytes =
    metrics.createPtr("proxy.process.http.err_client_read_error_origin_server_bytes");
  http_rsb.err_client_read_error_user_agent_bytes = metrics.createPtr("proxy.process.http.err_client_read_error_user_agent_bytes");
  http_rsb.err_connect_fail_count                 = metrics.createPtr("proxy.process.http.err_connect_fail_count");
  http_rsb.err_connect_fail_origin_server_bytes   = metrics.createPtr("proxy.process.http.err_connect_fail_origin_server_bytes");
  http_rsb.err_connect_fail_user_agent_bytes      = metrics.createPtr("proxy.process.http.err_connect_fail_user_agent_bytes");
  http_rsb.extension_method_requests              = metrics.createPtr("proxy.process.http.extension_method_requests");
  http_rsb.get_requests                           = metrics.createPtr("proxy.process.http.get_requests");
  http_rsb.head_requests                          = metrics.createPtr("proxy.process.http.head_requests");
  http_rsb.https_incoming_requests                = metrics.createPtr("proxy.process.https.incoming_requests");
  http_rsb.https_total_client_connections         = metrics.createPtr("proxy.process.https.total_client_connections");
  http_rsb.incoming_requests                      = metrics.createPtr("proxy.process.http.incoming_requests");
  http_rsb.incoming_responses                     = metrics.createPtr("proxy.process.http.incoming_responses");
  http_rsb.invalid_client_requests                = metrics.createPtr("proxy.process.http.invalid_client_requests");
  http_rsb.misc_count                             = metrics.createPtr("proxy.process.http.misc_count");
  http_rsb.misc_origin_server_bytes               = metrics.createPtr("proxy.process.http.http_misc_origin_server_bytes");
  http_rsb.misc_user_agent_bytes                  = metrics.createPtr("proxy.process.http.misc_user_agent_bytes");
  http_rsb.missing_host_hdr                       = metrics.createPtr("proxy.process.http.missing_host_hdr");
  http_rsb.options_requests                       = metrics.createPtr("proxy.process.http.options_requests");
  http_rsb.origin_body                            = metrics.createPtr("proxy.process.http.origin.body");
  http_rsb.origin_close_private                   = metrics.createPtr("proxy.process.http.origin.close_private");
  http_rsb.origin_connect_adjust_thread           = metrics.createPtr("proxy.process.http.origin.connect.adjust_thread");
  http_rsb.origin_connections_throttled           = metrics.createPtr("proxy.process.http.origin_connections_throttled_out");
  http_rsb.origin_make_new                        = metrics.createPtr("proxy.process.http.origin.make_new");
  http_rsb.origin_no_sharing                      = metrics.createPtr("proxy.process.http.origin.no_sharing");
  http_rsb.origin_not_found                       = metrics.createPtr("proxy.process.http.origin.not_found");
  http_rsb.origin_private                         = metrics.createPtr("proxy.process.http.origin.private");
  http_rsb.origin_raw                             = metrics.createPtr("proxy.process.http.origin.raw");
  http_rsb.origin_reuse                           = metrics.createPtr("proxy.process.http.origin.reuse");
  http_rsb.origin_reuse_fail                      = metrics.createPtr("proxy.process.http.origin.reuse_fail");
  http_rsb.origin_server_request_document_total_size =
    metrics.createPtr("proxy.process.http.origin_server_request_document_total_size");
  http_rsb.origin_server_request_header_total_size =
    metrics.createPtr("proxy.process.http.origin_server_request_header_total_size");
  http_rsb.origin_server_response_document_total_size =
    metrics.createPtr("proxy.process.http.origin_server_response_document_total_size");
  http_rsb.origin_server_response_header_total_size =
    metrics.createPtr("proxy.process.http.origin_server_response_header_total_size");
  http_rsb.origin_shutdown_cleanup_entry        = metrics.createPtr("proxy.process.http.origin_shutdown.cleanup_entry");
  http_rsb.origin_shutdown_migration_failure    = metrics.createPtr("proxy.process.http.origin_shutdown.migration_failure");
  http_rsb.origin_shutdown_pool_lock_contention = metrics.createPtr("proxy.process.http.origin_shutdown.pool_lock_contention");
  http_rsb.origin_shutdown_release_invalid_request =
    metrics.createPtr("proxy.process.http.origin_shutdown.release_invalid_request");
  http_rsb.origin_shutdown_release_invalid_response =
    metrics.createPtr("proxy.process.http.origin_shutdown.release_invalid_response");
  http_rsb.origin_shutdown_release_misc          = metrics.createPtr("proxy.process.http.origin_shutdown.release_misc");
  http_rsb.origin_shutdown_release_modified      = metrics.createPtr("proxy.process.http.origin_shutdown.release_modified");
  http_rsb.origin_shutdown_release_no_keep_alive = metrics.createPtr("proxy.process.http.origin_shutdown.release_no_keep_alive");
  http_rsb.origin_shutdown_release_no_server     = metrics.createPtr("proxy.process.http.origin_shutdown.release_no_server");
  http_rsb.origin_shutdown_release_no_sharing    = metrics.createPtr("proxy.process.http.origin_shutdown.release_no_sharing");
  http_rsb.origin_shutdown_tunnel_abort          = metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_abort");
  http_rsb.origin_shutdown_tunnel_client         = metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_client");
  http_rsb.origin_shutdown_tunnel_server         = metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_server");
  http_rsb.origin_shutdown_tunnel_server_detach  = metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_server_detach");
  http_rsb.origin_shutdown_tunnel_server_eos     = metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_server_eos");
  http_rsb.origin_shutdown_tunnel_server_no_keep_alive =
    metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_server_no_keep_alive");
  http_rsb.origin_shutdown_tunnel_server_plugin_tunnel =
    metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_server_plugin_tunnel");
  http_rsb.origin_shutdown_tunnel_transform_read  = metrics.createPtr("proxy.process.http.origin_shutdown.tunnel_transform_read");
  http_rsb.outgoing_requests                      = metrics.createPtr("proxy.process.http.outgoing_requests");
  http_rsb.parent_count                           = metrics.createPtr("proxy.process.http_parent_count");
  http_rsb.parent_proxy_request_total_bytes       = metrics.createPtr("proxy.process.http.parent_proxy_request_total_bytes");
  http_rsb.parent_proxy_response_total_bytes      = metrics.createPtr("proxy.process.http.parent_proxy_response_total_bytes");
  http_rsb.parent_proxy_transaction_time          = metrics.createPtr("proxy.process.http.parent_proxy_transaction_time");
  http_rsb.pooled_server_connections              = metrics.createPtr("proxy.process.http.pooled_server_connections");
  http_rsb.post_body_too_large                    = metrics.createPtr("proxy.process.http.post_body_too_large");
  http_rsb.post_requests                          = metrics.createPtr("proxy.process.http.post_requests");
  http_rsb.proxy_loop_detected                    = metrics.createPtr("proxy.process.http.http_proxy_loop_detected");
  http_rsb.proxy_mh_loop_detected                 = metrics.createPtr("proxy.process.http.http_proxy_mh_loop_detected");
  http_rsb.purge_requests                         = metrics.createPtr("proxy.process.http.purge_requests");
  http_rsb.push_requests                          = metrics.createPtr("proxy.process.http.push_requests");
  http_rsb.pushed_document_total_size             = metrics.createPtr("proxy.process.http.pushed_document_total_size");
  http_rsb.pushed_response_header_total_size      = metrics.createPtr("proxy.process.http.pushed_response_header_total_size");
  http_rsb.put_requests                           = metrics.createPtr("proxy.process.http.put_requests");
  http_rsb.response_status_100_count              = metrics.createPtr("proxy.process.http.100_responses");
  http_rsb.response_status_101_count              = metrics.createPtr("proxy.process.http.101_responses");
  http_rsb.response_status_1xx_count              = metrics.createPtr("proxy.process.http.1xx_responses");
  http_rsb.response_status_200_count              = metrics.createPtr("proxy.process.http.200_responses");
  http_rsb.response_status_201_count              = metrics.createPtr("proxy.process.http.201_responses");
  http_rsb.response_status_202_count              = metrics.createPtr("proxy.process.http.202_responses");
  http_rsb.response_status_203_count              = metrics.createPtr("proxy.process.http.203_responses");
  http_rsb.response_status_204_count              = metrics.createPtr("proxy.process.http.204_responses");
  http_rsb.response_status_205_count              = metrics.createPtr("proxy.process.http.205_responses");
  http_rsb.response_status_206_count              = metrics.createPtr("proxy.process.http.206_responses");
  http_rsb.response_status_2xx_count              = metrics.createPtr("proxy.process.http.2xx_responses");
  http_rsb.response_status_300_count              = metrics.createPtr("proxy.process.http.300_responses");
  http_rsb.response_status_301_count              = metrics.createPtr("proxy.process.http.301_responses");
  http_rsb.response_status_302_count              = metrics.createPtr("proxy.process.http.302_responses");
  http_rsb.response_status_303_count              = metrics.createPtr("proxy.process.http.303_responses");
  http_rsb.response_status_304_count              = metrics.createPtr("proxy.process.http.304_responses");
  http_rsb.response_status_305_count              = metrics.createPtr("proxy.process.http.305_responses");
  http_rsb.response_status_307_count              = metrics.createPtr("proxy.process.http.307_responses");
  http_rsb.response_status_308_count              = metrics.createPtr("proxy.process.http.308_responses");
  http_rsb.response_status_3xx_count              = metrics.createPtr("proxy.process.http.3xx_responses");
  http_rsb.response_status_400_count              = metrics.createPtr("proxy.process.http.400_responses");
  http_rsb.response_status_401_count              = metrics.createPtr("proxy.process.http.401_responses");
  http_rsb.response_status_402_count              = metrics.createPtr("proxy.process.http.402_responses");
  http_rsb.response_status_403_count              = metrics.createPtr("proxy.process.http.403_responses");
  http_rsb.response_status_404_count              = metrics.createPtr("proxy.process.http.404_responses");
  http_rsb.response_status_405_count              = metrics.createPtr("proxy.process.http.405_responses");
  http_rsb.response_status_406_count              = metrics.createPtr("proxy.process.http.406_responses");
  http_rsb.response_status_407_count              = metrics.createPtr("proxy.process.http.407_responses");
  http_rsb.response_status_408_count              = metrics.createPtr("proxy.process.http.408_responses");
  http_rsb.response_status_409_count              = metrics.createPtr("proxy.process.http.409_responses");
  http_rsb.response_status_410_count              = metrics.createPtr("proxy.process.http.410_responses");
  http_rsb.response_status_411_count              = metrics.createPtr("proxy.process.http.411_responses");
  http_rsb.response_status_412_count              = metrics.createPtr("proxy.process.http.412_responses");
  http_rsb.response_status_413_count              = metrics.createPtr("proxy.process.http.413_responses");
  http_rsb.response_status_414_count              = metrics.createPtr("proxy.process.http.414_responses");
  http_rsb.response_status_415_count              = metrics.createPtr("proxy.process.http.415_responses");
  http_rsb.response_status_416_count              = metrics.createPtr("proxy.process.http.416_responses");
  http_rsb.response_status_4xx_count              = metrics.createPtr("proxy.process.http.4xx_responses");
  http_rsb.response_status_500_count              = metrics.createPtr("proxy.process.http.500_responses");
  http_rsb.response_status_501_count              = metrics.createPtr("proxy.process.http.501_responses");
  http_rsb.response_status_502_count              = metrics.createPtr("proxy.process.http.502_responses");
  http_rsb.response_status_503_count              = metrics.createPtr("proxy.process.http.503_responses");
  http_rsb.response_status_504_count              = metrics.createPtr("proxy.process.http.504_responses");
  http_rsb.response_status_505_count              = metrics.createPtr("proxy.process.http.505_responses");
  http_rsb.response_status_5xx_count              = metrics.createPtr("proxy.process.http.5xx_responses");
  http_rsb.server_begin_write_time                = metrics.createPtr("proxy.process.http.milestone.server_begin_write");
  http_rsb.server_close_time                      = metrics.createPtr("proxy.process.http.milestone.server_close");
  http_rsb.server_connect_end_time                = metrics.createPtr("proxy.process.http.milestone.server_connect_end");
  http_rsb.server_connect_time                    = metrics.createPtr("proxy.process.http.milestone.server_connect");
  http_rsb.server_first_connect_time              = metrics.createPtr("proxy.process.http.milestone.server_first_connect");
  http_rsb.server_first_read_time                 = metrics.createPtr("proxy.process.http.milestone.server_first_read");
  http_rsb.server_read_header_done_time           = metrics.createPtr("proxy.process.http.milestone.server_read_header_done");
  http_rsb.sm_finish_time                         = metrics.createPtr("proxy.process.http.milestone.sm_finish");
  http_rsb.sm_start_time                          = metrics.createPtr("proxy.process.http.milestone.sm_start");
  http_rsb.tcp_client_refresh_count               = metrics.createPtr("proxy.process.http.tcp_client_refresh_count");
  http_rsb.tcp_client_refresh_origin_server_bytes = metrics.createPtr("proxy.process.http.tcp_client_refresh_origin_server_bytes");
  http_rsb.tcp_client_refresh_user_agent_bytes    = metrics.createPtr("proxy.process.http.tcp_client_refresh_user_agent_bytes");
  http_rsb.tcp_expired_miss_count                 = metrics.createPtr("proxy.process.http.tcp_expired_miss_count");
  http_rsb.tcp_expired_miss_origin_server_bytes   = metrics.createPtr("proxy.process.http.tcp_expired_miss_origin_server_bytes");
  http_rsb.tcp_expired_miss_user_agent_bytes      = metrics.createPtr("proxy.process.http.tcp_expired_miss_user_agent_bytes");
  http_rsb.tcp_hit_count                          = metrics.createPtr("proxy.process.http.tcp_hit_count");
  http_rsb.tcp_hit_origin_server_bytes            = metrics.createPtr("proxy.process.http.tcp_hit_origin_server_bytes");
  http_rsb.tcp_hit_user_agent_bytes               = metrics.createPtr("proxy.process.http.tcp_hit_user_agent_bytes");
  http_rsb.tcp_ims_hit_count                      = metrics.createPtr("proxy.process.http.tcp_ims_hit_count");
  http_rsb.tcp_ims_hit_origin_server_bytes        = metrics.createPtr("proxy.process.http.tcp_ims_hit_origin_server_bytes");
  http_rsb.tcp_ims_hit_user_agent_bytes           = metrics.createPtr("proxy.process.http.tcp_ims_hit_user_agent_bytes");
  http_rsb.tcp_ims_miss_count                     = metrics.createPtr("proxy.process.http.tcp_ims_miss_count");
  http_rsb.tcp_ims_miss_origin_server_bytes       = metrics.createPtr("proxy.process.http.tcp_ims_miss_origin_server_bytes");
  http_rsb.tcp_ims_miss_user_agent_bytes          = metrics.createPtr("proxy.process.http.tcp_ims_miss_user_agent_bytes");
  http_rsb.tcp_miss_count                         = metrics.createPtr("proxy.process.http.tcp_miss_count");
  http_rsb.tcp_miss_origin_server_bytes           = metrics.createPtr("proxy.process.http.tcp_miss_origin_server_bytes");
  http_rsb.tcp_miss_user_agent_bytes              = metrics.createPtr("proxy.process.http.tcp_miss_user_agent_bytes");
  http_rsb.tcp_refresh_hit_count                  = metrics.createPtr("proxy.process.http.tcp_refresh_hit_count");
  http_rsb.tcp_refresh_hit_origin_server_bytes    = metrics.createPtr("proxy.process.http.tcp_refresh_hit_origin_server_bytes");
  http_rsb.tcp_refresh_hit_user_agent_bytes       = metrics.createPtr("proxy.process.http.tcp_refresh_hit_user_agent_bytes");
  http_rsb.tcp_refresh_miss_count                 = metrics.createPtr("proxy.process.http.tcp_refresh_miss_count");
  http_rsb.tcp_refresh_miss_origin_server_bytes   = metrics.createPtr("proxy.process.http.tcp_refresh_miss_origin_server_bytes");
  http_rsb.tcp_refresh_miss_user_agent_bytes      = metrics.createPtr("proxy.process.http.tcp_refresh_miss_user_agent_bytes");
  http_rsb.total_client_connections               = metrics.createPtr("proxy.process.http.total_client_connections");
  http_rsb.total_client_connections_ipv4          = metrics.createPtr("proxy.process.http.total_client_connections_ipv4");
  http_rsb.total_client_connections_ipv6          = metrics.createPtr("proxy.process.http.total_client_connections_ipv6");
  http_rsb.total_incoming_connections             = metrics.createPtr("proxy.process.http.total_incoming_connections");
  http_rsb.total_parent_marked_down_count         = metrics.createPtr("proxy.process.http.total_parent_marked_down_count");
  http_rsb.total_parent_proxy_connections         = metrics.createPtr("proxy.process.http.total_parent_proxy_connections");
  http_rsb.total_parent_retries                   = metrics.createPtr("proxy.process.http.total_parent_retries");
  http_rsb.total_parent_retries_exhausted         = metrics.createPtr("proxy.process.http.total_parent_retries_exhausted");
  http_rsb.total_parent_switches                  = metrics.createPtr("proxy.process.http.total_parent_switches");
  http_rsb.total_server_connections               = metrics.createPtr("proxy.process.http.total_server_connections");
  http_rsb.total_transactions_time                = metrics.createPtr("proxy.process.http.total_transactions_time");
  http_rsb.total_x_redirect                       = metrics.createPtr("proxy.process.http.total_x_redirect_count");
  http_rsb.trace_requests                         = metrics.createPtr("proxy.process.http.trace_requests");
  http_rsb.tunnel_current_active_connections      = metrics.createPtr("proxy.process.tunnel.current_active_connections");
  http_rsb.tunnels                                = metrics.createPtr("proxy.process.http.tunnels");
  http_rsb.ua_begin_time                          = metrics.createPtr("proxy.process.http.milestone.ua_begin");
  http_rsb.ua_begin_write_time                    = metrics.createPtr("proxy.process.http.milestone.ua_begin_write");
  http_rsb.ua_close_time                          = metrics.createPtr("proxy.process.http.milestone.ua_close");
  http_rsb.ua_counts_errors_aborts                = metrics.createPtr("proxy.process.http.transaction_counts.errors.aborts");
  http_rsb.ua_counts_errors_connect_failed  = metrics.createPtr("proxy.process.http.transaction_counts.errors.connect_failed");
  http_rsb.ua_counts_errors_other           = metrics.createPtr("proxy.process.http.transaction_counts.errors.other");
  http_rsb.ua_counts_errors_possible_aborts = metrics.createPtr("proxy.process.http.transaction_counts.errors.possible_aborts");
  http_rsb.ua_counts_errors_pre_accept_hangups =
    metrics.createPtr("proxy.process.http.transaction_counts.errors.pre_accept_hangups");
  http_rsb.ua_counts_hit_fresh             = metrics.createPtr("proxy.process.http.transaction_counts.hit_fresh");
  http_rsb.ua_counts_hit_fresh_process     = metrics.createPtr("proxy.process.http.transaction_counts.hit_fresh.process");
  http_rsb.ua_counts_hit_reval             = metrics.createPtr("proxy.process.http.transaction_counts.hit_revalidated");
  http_rsb.ua_counts_miss_changed          = metrics.createPtr("proxy.process.http.transaction_counts.miss_changed");
  http_rsb.ua_counts_miss_client_no_cache  = metrics.createPtr("proxy.process.http.transaction_counts.miss_client_no_cache");
  http_rsb.ua_counts_miss_cold             = metrics.createPtr("proxy.process.http.transaction_counts.miss_cold");
  http_rsb.ua_counts_miss_uncacheable      = metrics.createPtr("proxy.process.http.transaction_counts.miss_not_cacheable");
  http_rsb.ua_counts_other_unclassified    = metrics.createPtr("proxy.process.http.transaction_counts.other.unclassified");
  http_rsb.ua_first_read_time              = metrics.createPtr("proxy.process.http.milestone.ua_first_read");
  http_rsb.ua_msecs_errors_aborts          = metrics.createPtr("proxy.process.http.transaction_totaltime.errors.aborts");
  http_rsb.ua_msecs_errors_connect_failed  = metrics.createPtr("proxy.process.http.transaction_totaltime.errors.connect_failed");
  http_rsb.ua_msecs_errors_other           = metrics.createPtr("proxy.process.http.transaction_totaltime.errors.other");
  http_rsb.ua_msecs_errors_possible_aborts = metrics.createPtr("proxy.process.http.transaction_totaltime.errors.possible_aborts");
  http_rsb.ua_msecs_errors_pre_accept_hangups =
    metrics.createPtr("proxy.process.http.transaction_totaltime.errors.pre_accept_hangups");
  http_rsb.ua_msecs_hit_fresh            = metrics.createPtr("proxy.process.http.transaction_totaltime.hit_fresh");
  http_rsb.ua_msecs_hit_fresh_process    = metrics.createPtr("proxy.process.http.transaction_totaltime.hit_fresh.process");
  http_rsb.ua_msecs_hit_reval            = metrics.createPtr("proxy.process.http.transaction_totaltime.hit_revalidated");
  http_rsb.ua_msecs_miss_changed         = metrics.createPtr("proxy.process.http.transaction_totaltime.miss_changed");
  http_rsb.ua_msecs_miss_client_no_cache = metrics.createPtr("proxy.process.http.transaction_totaltime.miss_client_no_cache");
  http_rsb.ua_msecs_miss_cold            = metrics.createPtr("proxy.process.http.transaction_totaltime.miss_cold");
  http_rsb.ua_msecs_miss_uncacheable     = metrics.createPtr("proxy.process.http.transaction_totaltime.miss_not_cacheable");
  http_rsb.ua_msecs_other_unclassified   = metrics.createPtr("proxy.process.http.transaction_totaltime.other.unclassified");
  http_rsb.ua_read_header_done_time      = metrics.createPtr("proxy.process.http.milestone.ua_read_header_done");
  http_rsb.user_agent_request_document_total_size = metrics.createPtr("proxy.process.http.user_agent_request_document_total_size");
  http_rsb.user_agent_request_header_total_size   = metrics.createPtr("proxy.process.http.user_agent_request_header_total_size");
  http_rsb.user_agent_response_document_total_size =
    metrics.createPtr("proxy.process.http.user_agent_response_document_total_size");
  http_rsb.user_agent_response_header_total_size = metrics.createPtr("proxy.process.http.user_agent_response_header_total_size");
  http_rsb.websocket_current_active_client_connections =
    metrics.createPtr("proxy.process.http.websocket.current_active_client_connections");
}
