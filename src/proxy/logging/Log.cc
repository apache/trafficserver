...
Log::init_fields()
{
  ...
  field = new LogField("client_ssl_cert_provided", "cscert", LogField::Type::STRING, &LogAccess::marshal_client_provided_cert,
                       &LogAccess::unmarshal_int_to_str);
  global_field_list.add(field, false);
  field_symbol_hash.emplace("cscert", field);

  field = new LogField("proxy_ssl_cert_provided", "pscert", LogField::Type::STRING, &LogAccess::marshal_proxy_provided_cert,
                       &LogAccess::unmarshal_int_to_str);
  global_field_list.add(field, false);
  ...
  field =
    new LogField("next_hop_port", "nhp", LogField::Type::IP, &LogAccess::marshal_next_hop_port, &LogAccess::unmarshal_int_to_str);
  global_field_list.add(field, false);
  ...
  field = new LogField("proxy_protocol_authority", "ppa", LogField::Type::IP, &LogAccess::marshal_proxy_protocol_authority,
                       &LogAccess::unmarshal_str);
  global_field_list.add(field, false);
