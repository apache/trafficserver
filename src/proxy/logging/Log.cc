...
Log::init_fields()
{
  ...
  register_field(new LogField("server_resp_http_version", "sshv", LogField::Type::dINT,
  ...
  register_field(new LogField("cached_resp_http_version", "csshv", LogField::Type::dINT,
