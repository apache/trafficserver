...
{
  RecEstablishStaticConfigInt32U(this->_header_table_size, "proxy.config.http3.header_table_size");
  RecEstablishStaticConfigInt32U(this->_max_field_section_size, "proxy.config.http3.max_field_section_size");
  RecEstablishStaticConfigInt32U(this->_qpack_blocked_streams, "proxy.config.http3.qpack_blocked_streams");
  RecEstablishStaticConfigInt32U(this->_num_placeholders, "proxy.config.http3.num_placeholders");
  RecEstablishStaticConfigInt32U(this->_max_settings, "proxy.config.http3.max_settings");
}
