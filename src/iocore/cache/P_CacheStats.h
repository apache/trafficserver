...
struct CacheStatsBlock {
  ...
  Metrics::Counter::AtomicType *bytes_used                = nullptr;
  Metrics::Counter::AtomicType *bytes_total               = nullptr;
  Metrics::Counter::AtomicType *stripes                   = nullptr;
  Metrics::Counter::AtomicType *ram_cache_bytes           = nullptr;
  Metrics::Counter::AtomicType *ram_cache_bytes_total     = nullptr;
  Metrics::Counter::AtomicType *direntries_total          = nullptr;
  Metrics::Counter::AtomicType *direntries_used           = nullptr;
  ...
  Metrics::Counter::AtomicType *percent_full              = nullptr;
  ...
  Metrics::Counter::AtomicType *directory_collision_count = nullptr;
  ...
  Metrics::Counter::AtomicType *span_offline              = nullptr;
  Metrics::Counter::AtomicType *span_online               = nullptr;
  Metrics::Counter::AtomicType *span_failing              = nullptr;
};
