...
// Whether the published store enumerates this name. Deliberately for_each rather than lookup(),
...
TEST_CASE("ConnectionTracker aggregate metric publication", "[libinknet][ConnectionTracker]")
{
