...
TEST_CASE("CN_match", "[X509HostnameValidator]")
{
  char *matching;
...
TEST_CASE("bad_wildcard_SANs", "[X509HostnameValidator]")
{
...
TEST_CASE("wildcard_SAN_and_CN", "[X509HostnameValidator]")
{
  char *matching;
...
TEST_CASE("IDNA_hostnames", "[X509HostnameValidator]")
{
  char *matching;
  X509 *x = load_cert_from_string(test_certificate_cn_and_SANs);
  REQUIRE(x != nullptr);
...
TEST_CASE("middle_label_match", "[X509HostnameValidator]")
{
  char *matching;
  X509 *x = load_cert_from_string(test_certificate_cn_and_SANs);
  REQUIRE(x != nullptr);
