...
std::mutex            SnowflakeIDUtils::m_mutex;

uint64_t   SnowflakeID::m_last_timestamp{0};
uint64_t   SnowflakeID::m_last_sequence{0};
std::mutex SnowflakeID::m_mutex;
...
std::string_view
SnowflakeIDUtils::get_string(uint64_t snowflake_value)
{
  if (m_snowflake_value != snowflake_value || m_id_string.empty()) {
    m_snowflake_value = snowflake_value;
...
SnowflakeID::SnowflakeID()
{
  ...
  this->m_snowflake.pieces.always_zero = 0;
  this->m_snowflake.pieces.machine_id  = SnowflakeIDUtils::get_machine_id();
  ...
  this->m_snowflake.pieces.timestamp = now;
  this->m_snowflake.pieces.sequence  = local_last_sequence;
}

std::string_view
SnowflakeID::get_string()
{
  return m_utils.get_string(this->m_snowflake.value);
}

SnowflakeIdNoSequence::SnowflakeIdNoSequence()
{
  this->m_snowflake.pieces.always_zero = 0;
  this->m_snowflake.pieces.machine_id  = SnowflakeIDUtils::get_machine_id();
