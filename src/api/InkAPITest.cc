...
std::array<std::string_view, TS_CONFIG_LAST_ENTRY> SDK_Overridable_Configs = {
  {
   ...
   "proxy.config.http.negative_caching_list", "proxy.config.http.cache.when_to_revalidate",
   ...
   "proxy.config.http.negative_revalidating_list", "proxy.config.ssl.hsts_max_age",
