...
api_init()
{
  ...
  if (init) {
    ...
    /* MIME fields */
    TS_MIME_FIELD_ACCEPT                    = MIME_FIELD_ACCEPT_sv.data();
    TS_MIME_FIELD_ACCEPT_CHARSET            = MIME_FIELD_ACCEPT_CHARSET_sv.data();
    TS_MIME_FIELD_ACCEPT_ENCODING           = MIME_FIELD_ACCEPT_ENCODING_sv.data();
    TS_MIME_FIELD_ACCEPT_LANGUAGE           = MIME_FIELD_ACCEPT_LANGUAGE_sv.data();
    TS_MIME_FIELD_ACCEPT_RANGES             = MIME_FIELD_ACCEPT_RANGES_sv.data();
    TS_MIME_FIELD_AGE                       = MIME_FIELD_AGE_sv.data();
    TS_MIME_FIELD_ALLOW                     = MIME_FIELD_ALLOW_sv.data();
    TS_MIME_FIELD_APPROVED                  = MIME_FIELD_APPROVED_sv.data();
    TS_MIME_FIELD_AUTHORIZATION             = MIME_FIELD_AUTHORIZATION_sv.data();
    TS_MIME_FIELD_BYTES                     = MIME_FIELD_BYTES_sv.data();
    TS_MIME_FIELD_CACHE_CONTROL             = MIME_FIELD_CACHE_CONTROL_sv.data();
    TS_MIME_FIELD_CLIENT_IP                 = MIME_FIELD_CLIENT_IP_sv.data();
    TS_MIME_FIELD_CONNECTION                = MIME_FIELD_CONNECTION_sv.data();
    TS_MIME_FIELD_CONTENT_BASE              = MIME_FIELD_CONTENT_BASE_sv.data();
    TS_MIME_FIELD_CONTENT_ENCODING          = MIME_FIELD_CONTENT_ENCODING_sv.data();
    TS_MIME_FIELD_CONTENT_LANGUAGE          = MIME_FIELD_CONTENT_LANGUAGE_sv.data();
    TS_MIME_FIELD_CONTENT_LENGTH            = MIME_FIELD_CONTENT_LENGTH_sv.data();
    TS_MIME_FIELD_CONTENT_LOCATION          = MIME_FIELD_CONTENT_LOCATION_sv.data();
    TS_MIME_FIELD_CONTENT_MD5               = MIME_FIELD_CONTENT_MD5_sv.data();
    TS_MIME_FIELD_CONTENT_RANGE             = MIME_FIELD_CONTENT_RANGE_sv.data();
    TS_MIME_FIELD_CONTENT_TYPE              = MIME_FIELD_CONTENT_TYPE_sv.data();
    TS_MIME_FIELD_CONTROL                   = MIME_FIELD_CONTROL_sv.data();
    TS_MIME_FIELD_COOKIE                    = MIME_FIELD_COOKIE_sv.data();
    TS_MIME_FIELD_DATE                      = MIME_FIELD_DATE_sv.data();
    TS_MIME_FIELD_DISTRIBUTION              = MIME_FIELD_DISTRIBUTION_sv.data();
    TS_MIME_FIELD_ETAG                      = MIME_FIELD_ETAG_sv.data();
    TS_MIME_FIELD_EXPECT                    = MIME_FIELD_EXPECT_sv.data();
    TS_MIME_FIELD_EXPIRES                   = MIME_FIELD_EXPIRES_sv.data();
    TS_MIME_FIELD_FOLLOWUP_TO               = MIME_FIELD_FOLLOWUP_TO_sv.data();
    TS_MIME_FIELD_FROM                      = MIME_FIELD_FROM_sv.data();
    TS_MIME_FIELD_HOST                      = MIME_FIELD_HOST_sv.data();
    TS_MIME_FIELD_IF_MATCH                  = MIME_FIELD_IF_MATCH_sv.data();
    TS_MIME_FIELD_IF_MODIFIED_SINCE         = MIME_FIELD_IF_MODIFIED_SINCE_sv.data();
    TS_MIME_FIELD_IF_NONE_MATCH             = MIME_FIELD_IF_NONE_MATCH_sv.data();
    TS_MIME_FIELD_IF_RANGE                  = MIME_FIELD_IF_RANGE_sv.data();
    TS_MIME_FIELD_IF_UNMODIFIED_SINCE       = MIME_FIELD_IF_UNMODIFIED_SINCE_sv.data();
    TS_MIME_FIELD_KEEP_ALIVE                = MIME_FIELD_KEEP_ALIVE_sv.data();
    TS_MIME_FIELD_KEYWORDS                  = MIME_FIELD_KEYWORDS_sv.data();
    TS_MIME_FIELD_LAST_MODIFIED             = MIME_FIELD_LAST_MODIFIED_sv.data();
    TS_MIME_FIELD_LINES                     = MIME_FIELD_LINES_sv.data();
    TS_MIME_FIELD_LOCATION                  = MIME_FIELD_LOCATION_sv.data();
    TS_MIME_FIELD_MAX_FORWARDS              = MIME_FIELD_MAX_FORWARDS_sv.data();
    TS_MIME_FIELD_MESSAGE_ID                = MIME_FIELD_MESSAGE_ID_sv.data();
    TS_MIME_FIELD_NEWSGROUPS                = MIME_FIELD_NEWSGROUPS_sv.data();
    TS_MIME_FIELD_ORGANIZATION              = MIME_FIELD_ORGANIZATION_sv.data();
    TS_MIME_FIELD_PATH                      = MIME_FIELD_PATH_sv.data();
    TS_MIME_FIELD_PRAGMA                    = MIME_FIELD_PRAGMA_sv.data();
    TS_MIME_FIELD_PROXY_AUTHENTICATE        = MIME_FIELD_PROXY_AUTHENTICATE_sv.data();
    TS_MIME_FIELD_PROXY_AUTHORIZATION       = MIME_FIELD_PROXY_AUTHORIZATION_sv.data();
    TS_MIME_FIELD_PROXY_CONNECTION          = MIME_FIELD_PROXY_CONNECTION_sv.data();
    TS_MIME_FIELD_PUBLIC                    = MIME_FIELD_PUBLIC_sv.data();
    TS_MIME_FIELD_RANGE                     = MIME_FIELD_RANGE_sv.data();
    TS_MIME_FIELD_REFERENCES                = MIME_FIELD_REFERENCES_sv.data();
    TS_MIME_FIELD_REFERER                   = MIME_FIELD_REFERER_sv.data();
    TS_MIME_FIELD_REPLY_TO                  = MIME_FIELD_REPLY_TO_sv.data();
    TS_MIME_FIELD_RETRY_AFTER               = MIME_FIELD_RETRY_AFTER_sv.data();
    TS_MIME_FIELD_SENDER                    = MIME_FIELD_SENDER_sv.data();
    TS_MIME_FIELD_SERVER                    = MIME_FIELD_SERVER_sv.data();
    TS_MIME_FIELD_SET_COOKIE                = MIME_FIELD_SET_COOKIE_sv.data();
    TS_MIME_FIELD_STRICT_TRANSPORT_SECURITY = MIME_FIELD_STRICT_TRANSPORT_SECURITY_sv.data();
    TS_MIME_FIELD_SUBJECT                   = MIME_FIELD_SUBJECT_sv.data();
    TS_MIME_FIELD_SUMMARY                   = MIME_FIELD_SUMMARY_sv.data();
    TS_MIME_FIELD_TE                        = MIME_FIELD_TE_sv.data();
    TS_MIME_FIELD_TRANSFER_ENCODING         = MIME_FIELD_TRANSFER_ENCODING_sv.data();
    TS_MIME_FIELD_UPGRADE                   = MIME_FIELD_UPGRADE_sv.data();
    TS_MIME_FIELD_USER_AGENT                = MIME_FIELD_USER_AGENT_sv.data();
    TS_MIME_FIELD_VARY                      = MIME_FIELD_VARY_sv.data();
    TS_MIME_FIELD_VIA                       = MIME_FIELD_VIA_sv.data();
    TS_MIME_FIELD_WARNING                   = MIME_FIELD_WARNING_sv.data();
    TS_MIME_FIELD_WWW_AUTHENTICATE          = MIME_FIELD_WWW_AUTHENTICATE_sv.data();
    TS_MIME_FIELD_XREF                      = MIME_FIELD_XREF_sv.data();
    TS_MIME_FIELD_X_FORWARDED_FOR           = MIME_FIELD_X_FORWARDED_FOR_sv.data();
    TS_MIME_FIELD_FORWARDED                 = MIME_FIELD_FORWARDED_sv.data();

    TS_MIME_LEN_ACCEPT                    = static_cast<int>(MIME_FIELD_ACCEPT_sv.length());
    TS_MIME_LEN_ACCEPT_CHARSET            = static_cast<int>(MIME_FIELD_ACCEPT_CHARSET_sv.length());
    TS_MIME_LEN_ACCEPT_ENCODING           = static_cast<int>(MIME_FIELD_ACCEPT_ENCODING_sv.length());
    TS_MIME_LEN_ACCEPT_LANGUAGE           = static_cast<int>(MIME_FIELD_ACCEPT_LANGUAGE_sv.length());
    TS_MIME_LEN_ACCEPT_RANGES             = static_cast<int>(MIME_FIELD_ACCEPT_RANGES_sv.length());
    TS_MIME_LEN_AGE                       = static_cast<int>(MIME_FIELD_AGE_sv.length());
    TS_MIME_LEN_ALLOW                     = static_cast<int>(MIME_FIELD_ALLOW_sv.length());
    TS_MIME_LEN_APPROVED                  = static_cast<int>(MIME_FIELD_APPROVED_sv.length());
    TS_MIME_LEN_AUTHORIZATION             = static_cast<int>(MIME_FIELD_AUTHORIZATION_sv.length());
    TS_MIME_LEN_BYTES                     = static_cast<int>(MIME_FIELD_BYTES_sv.length());
    TS_MIME_LEN_CACHE_CONTROL             = static_cast<int>(MIME_FIELD_CACHE_CONTROL_sv.length());
    TS_MIME_LEN_CLIENT_IP                 = static_cast<int>(MIME_FIELD_CLIENT_IP_sv.length());
    TS_MIME_LEN_CONNECTION                = static_cast<int>(MIME_FIELD_CONNECTION_sv.length());
    TS_MIME_LEN_CONTENT_BASE              = static_cast<int>(MIME_FIELD_CONTENT_BASE_sv.length());
    TS_MIME_LEN_CONTENT_ENCODING          = static_cast<int>(MIME_FIELD_CONTENT_ENCODING_sv.length());
    TS_MIME_LEN_CONTENT_LANGUAGE          = static_cast<int>(MIME_FIELD_CONTENT_LANGUAGE_sv.length());
    TS_MIME_LEN_CONTENT_LENGTH            = static_cast<int>(MIME_FIELD_CONTENT_LENGTH_sv.length());
    TS_MIME_LEN_CONTENT_LOCATION          = static_cast<int>(MIME_FIELD_CONTENT_LOCATION_sv.length());
    TS_MIME_LEN_CONTENT_MD5               = static_cast<int>(MIME_FIELD_CONTENT_MD5_sv.length());
    TS_MIME_LEN_CONTENT_RANGE             = static_cast<int>(MIME_FIELD_CONTENT_RANGE_sv.length());
    TS_MIME_LEN_CONTENT_TYPE              = static_cast<int>(MIME_FIELD_CONTENT_TYPE_sv.length());
    TS_MIME_LEN_CONTROL                   = static_cast<int>(MIME_FIELD_CONTROL_sv.length());
    TS_MIME_LEN_COOKIE                    = static_cast<int>(MIME_FIELD_COOKIE_sv.length());
    TS_MIME_LEN_DATE                      = static_cast<int>(MIME_FIELD_DATE_sv.length());
    TS_MIME_LEN_DISTRIBUTION              = static_cast<int>(MIME_FIELD_DISTRIBUTION_sv.length());
    TS_MIME_LEN_ETAG                      = static_cast<int>(MIME_FIELD_ETAG_sv.length());
    TS_MIME_LEN_EXPECT                    = static_cast<int>(MIME_FIELD_EXPECT_sv.length());
    TS_MIME_LEN_EXPIRES                   = static_cast<int>(MIME_FIELD_EXPIRES_sv.length());
    TS_MIME_LEN_FOLLOWUP_TO               = static_cast<int>(MIME_FIELD_FOLLOWUP_TO_sv.length());
    TS_MIME_LEN_FROM                      = static_cast<int>(MIME_FIELD_FROM_sv.length());
    TS_MIME_LEN_HOST                      = static_cast<int>(MIME_FIELD_HOST_sv.length());
    TS_MIME_LEN_IF_MATCH                  = static_cast<int>(MIME_FIELD_IF_MATCH_sv.length());
    TS_MIME_LEN_IF_MODIFIED_SINCE         = static_cast<int>(MIME_FIELD_IF_MODIFIED_SINCE_sv.length());
    TS_MIME_LEN_IF_NONE_MATCH             = static_cast<int>(MIME_FIELD_IF_NONE_MATCH_sv.length());
    TS_MIME_LEN_IF_RANGE                  = static_cast<int>(MIME_FIELD_IF_RANGE_sv.length());
    TS_MIME_LEN_IF_UNMODIFIED_SINCE       = static_cast<int>(MIME_FIELD_IF_UNMODIFIED_SINCE_sv.length());
    TS_MIME_LEN_KEEP_ALIVE                = static_cast<int>(MIME_FIELD_KEEP_ALIVE_sv.length());
    TS_MIME_LEN_KEYWORDS                  = static_cast<int>(MIME_FIELD_KEYWORDS_sv.length());
    TS_MIME_LEN_LAST_MODIFIED             = static_cast<int>(MIME_FIELD_LAST_MODIFIED_sv.length());
    TS_MIME_LEN_LINES                     = static_cast<int>(MIME_FIELD_LINES_sv.length());
    TS_MIME_LEN_LOCATION                  = static_cast<int>(MIME_FIELD_LOCATION_sv.length());
    TS_MIME_LEN_MAX_FORWARDS              = static_cast<int>(MIME_FIELD_MAX_FORWARDS_sv.length());
    TS_MIME_LEN_MESSAGE_ID                = static_cast<int>(MIME_FIELD_MESSAGE_ID_sv.length());
    TS_MIME_LEN_NEWSGROUPS                = static_cast<int>(MIME_FIELD_NEWSGROUPS_sv.length());
    TS_MIME_LEN_ORGANIZATION              = static_cast<int>(MIME_FIELD_ORGANIZATION_sv.length());
    TS_MIME_LEN_PATH                      = static_cast<int>(MIME_FIELD_PATH_sv.length());
    TS_MIME_LEN_PRAGMA                    = static_cast<int>(MIME_FIELD_PRAGMA_sv.length());
    TS_MIME_LEN_PROXY_AUTHENTICATE        = static_cast<int>(MIME_FIELD_PROXY_AUTHENTICATE_sv.length());
    TS_MIME_LEN_PROXY_AUTHORIZATION       = static_cast<int>(MIME_FIELD_PROXY_AUTHORIZATION_sv.length());
    TS_MIME_LEN_PROXY_CONNECTION          = static_cast<int>(MIME_FIELD_PROXY_CONNECTION_sv.length());
    TS_MIME_LEN_PUBLIC                    = static_cast<int>(MIME_FIELD_PUBLIC_sv.length());
    TS_MIME_LEN_RANGE                     = static_cast<int>(MIME_FIELD_RANGE_sv.length());
    TS_MIME_LEN_REFERENCES                = static_cast<int>(MIME_FIELD_REFERENCES_sv.length());
    TS_MIME_LEN_REFERER                   = static_cast<int>(MIME_FIELD_REFERER_sv.length());
    TS_MIME_LEN_REPLY_TO                  = static_cast<int>(MIME_FIELD_REPLY_TO_sv.length());
    TS_MIME_LEN_RETRY_AFTER               = static_cast<int>(MIME_FIELD_RETRY_AFTER_sv.length());
    TS_MIME_LEN_SENDER                    = static_cast<int>(MIME_FIELD_SENDER_sv.length());
    TS_MIME_LEN_SERVER                    = static_cast<int>(MIME_FIELD_SERVER_sv.length());
    TS_MIME_LEN_SET_COOKIE                = static_cast<int>(MIME_FIELD_SET_COOKIE_sv.length());
    TS_MIME_LEN_STRICT_TRANSPORT_SECURITY = static_cast<int>(MIME_FIELD_STRICT_TRANSPORT_SECURITY_sv.length());
    TS_MIME_LEN_SUBJECT                   = static_cast<int>(MIME_FIELD_SUBJECT_sv.length());
    TS_MIME_LEN_SUMMARY                   = static_cast<int>(MIME_FIELD_SUMMARY_sv.length());
    TS_MIME_LEN_TE                        = static_cast<int>(MIME_FIELD_TE_sv.length());
    TS_MIME_LEN_TRANSFER_ENCODING         = static_cast<int>(MIME_FIELD_TRANSFER_ENCODING_sv.length());
    TS_MIME_LEN_UPGRADE                   = static_cast<int>(MIME_FIELD_UPGRADE_sv.length());
    TS_MIME_LEN_USER_AGENT                = static_cast<int>(MIME_FIELD_USER_AGENT_sv.length());
    TS_MIME_LEN_VARY                      = static_cast<int>(MIME_FIELD_VARY_sv.length());
    TS_MIME_LEN_VIA                       = static_cast<int>(MIME_FIELD_VIA_sv.length());
    TS_MIME_LEN_WARNING                   = static_cast<int>(MIME_FIELD_WARNING_sv.length());
    TS_MIME_LEN_WWW_AUTHENTICATE          = static_cast<int>(MIME_FIELD_WWW_AUTHENTICATE_sv.length());
    TS_MIME_LEN_XREF                      = static_cast<int>(MIME_FIELD_XREF_sv.length());
    TS_MIME_LEN_X_FORWARDED_FOR           = static_cast<int>(MIME_FIELD_X_FORWARDED_FOR_sv.length());
    TS_MIME_LEN_FORWARDED                 = static_cast<int>(MIME_FIELD_FORWARDED_sv.length());
