...
SymbolResolver::SymbolResolver()
{
  ...
  _condition_map = {
    ...
    {"from.url.query.",
     {.target = "FROM-URL:QUERY", .sections = HTTP_SECTIONS, .prefix = true, .cond_type = hrw::ConditionType::COND_FROM_URL}           },
    {"from.url.",
     {.sections              = HTTP_SECTIONS,
      .upper                 = true,
      .prefix                = true,
    ...
    {"inbound.url.query.",
     {.target = "CLIENT-URL:QUERY", .sections = HTTP_SECTIONS, .prefix = true, .cond_type = hrw::ConditionType::COND_CLIENT_URL}       },
    {"inbound.url.",
     {.sections              = HTTP_SECTIONS,
      .upper                 = true,
      .prefix                = true,
    ...
    {"outbound.url.",
     {.upper                 = true,
      ...
      .cond_type             = hrw::ConditionType::COND_NEXT_HOP}                                                                      },
    {"to.url.query.",
     {.target = "TO-URL:QUERY", .sections = HTTP_SECTIONS, .prefix = true, .cond_type = hrw::ConditionType::COND_TO_URL}               },
    {"to.url.",
     {.upper                 = true,
      .prefix                = true,
      .suffix_group          = SuffixGroup::URL_FIELDS,
