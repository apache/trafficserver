...
private:
  ...
  /// Report that this build has no POSIX shared memory support (see TS_USE_CACHE_SHM),
  /// so both subcommands have nothing to act on.
  void report_unsupported();

  std::string get_prefix();
  std::string default_prefix_hint();
};
