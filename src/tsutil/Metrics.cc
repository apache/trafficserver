...
void
Metrics::Storage::_addBlob() // The mutex must be held before calling this!
{
...
Metrics::IdType
Metrics::Storage::_create(std::string_view name)
{
...
Metrics::SpanType
Metrics::Storage::_createSpan(size_t size, Metrics::IdType *id)
{
