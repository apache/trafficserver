...
const char *SDK_Overridable_Configs[TS_CONFIG_LAST_ENTRY] = {
  ...
  "proxy.config.http.auth_server_session_private", "proxy.config.http.slow.log.threshold", "proxy.config.http.cache.generation","proxy.config.error.response.type"};
