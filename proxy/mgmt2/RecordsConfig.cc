...
RecordElement RecordsConfig[] = {
  ...
  ,
  {RECT_CONFIG, "proxy.config.net.max_poll_delay", RECD_INT, "128", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.dns.splitdns.def_domain", RECD_STRING, NULL, RECU_DYNAMIC, RR_NULL, RECC_STR, "^[^[:space:]]*$", RECA_NULL}
  ,
