...
static inline void
setup_udp_header(char *header, uint32 seq_no, uint32 pkt_no, bool last_pkt)
{
...
static inline void
setup_object_header(char *header, uint32 size, bool url_promise)
{
  uint32 *hdr = (uint32 *) header;
  hdr[0] = htonl(size);
...
PrefetchBlaster::init(PrefetchUrlEntry * entry, HTTPHdr * req_hdr, PrefetchTransform * p_trans)
{
  ...
  DUMP_HEADER("PrefetchBlasterHdrs", request, (int64)0, "Request Header from Prefetch Blaster");
...
Lcheckcookie:
  ...
  DUMP_HEADER("PrefetchCookies", req_hdr, (int64)0,
              "Request Header for the top page used as the base for the new request with Cookies");
  DUMP_HEADER("PrefetchCookies", resp_hdr, (int64)0,
              "Response Header for the top page used as the base for the new request with Cookies");
  DUMP_HEADER("PrefetchCookies", request, (int64)0, "Request Header with Cookies generated by Prefetch Parser");
}
