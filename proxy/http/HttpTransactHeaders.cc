...
HttpTransactHeaders::insert_supported_methods_in_response(HTTPHdr *response, int scheme)
{
  ...
  const char *methods[] = {
    ...
    HTTP_METHOD_POST, HTTP_METHOD_PURGE, HTTP_METHOD_PUT, HTTP_METHOD_PUSH, HTTP_METHOD_TRACE, HTTP_METHOD_COPY, HTTP_METHOD_MOVE,
    HTTP_METHOD_PROPFIND, HTTP_METHOD_PROPPATCH, HTTP_METHOD_LOCK, HTTP_METHOD_UNLOCK, HTTP_METHOD_MKCOL, HTTP_METHOD_REPORT,
