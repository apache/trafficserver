...
struct OverridableHttpConfigParams {
  OverridableHttpConfigParams()
    : maintain_pristine_host_hdr(1), chunking_enabled(1), negative_caching_enabled(0), negative_revalidating_enabled(0),
      ...
      parent_connect_attempts(4), per_parent_connect_attempts(2), simple_retry_enabled(0), dead_server_retry_enabled(0),
      ...
      redirection_enabled(0), redirect_use_orig_cache_key(0), number_of_redirections(1), simple_retry_response_codes_string(NULL),
