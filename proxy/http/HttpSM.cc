...
namespace {
  ...
  milestone_update_api_time(TransactionMilestones& milestones, ink_hrtime& api_timer)
  {
    ...
    if (api_timer) {
      ...
      if (0 == milestones.plugin_total) milestones.plugin_total = milestones.sm_start;
      milestones.plugin_total += delta;
      if (active) {
        if (0 == milestones.plugin_active) milestones.plugin_active = milestones.sm_start;
