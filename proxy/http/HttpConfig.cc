...
register_stat_callbacks()
{
  ...
  http_rsb.background_fill_bytes_aborted        = intm.newMetricPtr("proxy.process.http.background_fill_bytes_aborted_stat");
  http_rsb.background_fill_bytes_completed      = intm.newMetricPtr("proxy.process.http.background_fill_bytes_completed_stat");
  ...
  http_rsb.err_client_abort_count               = intm.newMetricPtr("proxy.process.http.err_client_abort_count_stat");
  http_rsb.err_client_abort_origin_server_bytes = intm.newMetricPtr("proxy.process.http.err_client_abort_origin_server_bytes_stat");
  http_rsb.err_client_abort_user_agent_bytes    = intm.newMetricPtr("proxy.process.http.err_client_abort_user_agent_bytes_stat");
  http_rsb.err_client_read_error_count          = intm.newMetricPtr("proxy.process.http.err_client_read_error_count_stat");
  http_rsb.err_client_read_error_origin_server_bytes =
    intm.newMetricPtr("proxy.process.http.err_client_read_error_origin_server_bytes_stat");
  http_rsb.err_client_read_error_user_agent_bytes =
    intm.newMetricPtr("proxy.process.http.err_client_read_error_user_agent_bytes_stat");
  http_rsb.err_connect_fail_count               = intm.newMetricPtr("proxy.process.http.err_connect_fail_count_stat");
  http_rsb.err_connect_fail_origin_server_bytes = intm.newMetricPtr("proxy.process.http.err_connect_fail_origin_server_bytes_stat");
  http_rsb.err_connect_fail_user_agent_bytes    = intm.newMetricPtr("proxy.process.http.err_connect_fail_user_agent_bytes_stat");
  ...
  http_rsb.tcp_client_refresh_count              = intm.newMetricPtr("proxy.process.http.tcp_client_refresh_count_stat");
  http_rsb.tcp_client_refresh_origin_server_bytes =
    intm.newMetricPtr("proxy.process.http.tcp_client_refresh_origin_server_bytes_stat");
  http_rsb.tcp_client_refresh_user_agent_bytes  = intm.newMetricPtr("proxy.process.http.tcp_client_refresh_user_agent_bytes_stat");
  http_rsb.tcp_expired_miss_count               = intm.newMetricPtr("proxy.process.http.tcp_expired_miss_count_stat");
  http_rsb.tcp_expired_miss_origin_server_bytes = intm.newMetricPtr("proxy.process.http.tcp_expired_miss_origin_server_bytes_stat");
  http_rsb.tcp_expired_miss_user_agent_bytes    = intm.newMetricPtr("proxy.process.http.tcp_expired_miss_user_agent_bytes_stat");
  http_rsb.tcp_hit_count                        = intm.newMetricPtr("proxy.process.http.tcp_hit_count_stat");
  http_rsb.tcp_hit_origin_server_bytes          = intm.newMetricPtr("proxy.process.http.tcp_hit_origin_server_bytes_stat");
  http_rsb.tcp_hit_user_agent_bytes             = intm.newMetricPtr("proxy.process.http.tcp_hit_user_agent_bytes_stat");
  http_rsb.tcp_ims_hit_count                    = intm.newMetricPtr("proxy.process.http.tcp_ims_hit_count_stat");
  http_rsb.tcp_ims_hit_origin_server_bytes      = intm.newMetricPtr("proxy.process.http.tcp_ims_hit_origin_server_bytes_stat");
  http_rsb.tcp_ims_hit_user_agent_bytes         = intm.newMetricPtr("proxy.process.http.tcp_ims_hit_user_agent_bytes_stat");
  http_rsb.tcp_ims_miss_count                   = intm.newMetricPtr("proxy.process.http.tcp_ims_miss_count_stat");
  http_rsb.tcp_ims_miss_origin_server_bytes     = intm.newMetricPtr("proxy.process.http.tcp_ims_miss_origin_server_bytes_stat");
  http_rsb.tcp_ims_miss_user_agent_bytes        = intm.newMetricPtr("proxy.process.http.tcp_ims_miss_user_agent_bytes_stat");
  http_rsb.tcp_miss_count                       = intm.newMetricPtr("proxy.process.http.tcp_miss_count_stat");
  http_rsb.tcp_miss_origin_server_bytes         = intm.newMetricPtr("proxy.process.http.tcp_miss_origin_server_bytes_stat");
  http_rsb.tcp_miss_user_agent_bytes            = intm.newMetricPtr("proxy.process.http.tcp_miss_user_agent_bytes_stat");
  http_rsb.tcp_refresh_hit_count                = intm.newMetricPtr("proxy.process.http.tcp_refresh_hit_count_stat");
  http_rsb.tcp_refresh_hit_origin_server_bytes  = intm.newMetricPtr("proxy.process.http.tcp_refresh_hit_origin_server_bytes_stat");
  http_rsb.tcp_refresh_hit_user_agent_bytes     = intm.newMetricPtr("proxy.process.http.tcp_refresh_hit_user_agent_bytes_stat");
  http_rsb.tcp_refresh_miss_count               = intm.newMetricPtr("proxy.process.http.tcp_refresh_miss_count_stat");
  http_rsb.tcp_refresh_miss_origin_server_bytes = intm.newMetricPtr("proxy.process.http.tcp_refresh_miss_origin_server_bytes_stat");
  http_rsb.tcp_refresh_miss_user_agent_bytes    = intm.newMetricPtr("proxy.process.http.tcp_refresh_miss_user_agent_bytes_stat");
