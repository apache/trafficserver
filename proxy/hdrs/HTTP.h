...
extern const char *HTTP_METHOD_COPY;
extern const char *HTTP_METHOD_MOVE;
extern const char *HTTP_METHOD_PROPFIND;
extern const char *HTTP_METHOD_PROPPATCH;
extern const char *HTTP_METHOD_LOCK;
extern const char *HTTP_METHOD_UNLOCK;
extern const char *HTTP_METHOD_MKCOL;
extern const char *HTTP_METHOD_REPORT;
extern const char *HTTP_METHOD_CHECKOUT;
...
extern int HTTP_WKSIDX_COPY;
extern int HTTP_WKSIDX_MOVE;
extern int HTTP_WKSIDX_PROPFIND;
extern int HTTP_WKSIDX_PROPPATCH;
extern int HTTP_WKSIDX_LOCK;
extern int HTTP_WKSIDX_UNLOCK;
extern int HTTP_WKSIDX_MKCOL;
extern int HTTP_WKSIDX_REPORT;
extern int HTTP_WKSIDX_CHECKOUT;
...
extern int HTTP_LEN_COPY;
extern int HTTP_LEN_MOVE;
extern int HTTP_LEN_PROPFIND;
extern int HTTP_LEN_PROPPATCH;
extern int HTTP_LEN_LOCK;
extern int HTTP_LEN_UNLOCK;
extern int HTTP_LEN_MKCOL;
extern int HTTP_LEN_REPORT;
extern int HTTP_LEN_CHECKOUT;
