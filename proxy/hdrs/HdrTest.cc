...
HdrTest::test_url()
{
  ...
  static const char *bad[] = {
    "http://[1:2:3:4:5:6:7:8:9]", "http://1:2:3:4:5:6:7:8:A:B", "http://bob.com[::1]", "http://[::1].com",

    "http://foo:bar:baz@bob.com/", "http://foo:bar:baz@[::1]:8080/",

    "http://]", "http://:",

    "http:/", "http:/foo.bar.com/", "~http://invalid.char.in.scheme/foo", "http~://invalid.char.in.scheme/foo",
    "ht~tp://invalid.char.in.scheme/foo", "1http://first.char.not.alpha", "some.domain.com/http://invalid.domain/foo", ":", "://",
