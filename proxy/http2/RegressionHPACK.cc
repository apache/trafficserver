...
const static struct {
  ...
  int prefix;
                         ...
                         {42, reinterpret_cast<const uint8_t *>("\x2A"), 1, 8}};
...
const static struct {
  ...
  const uint8_t *encoded_field;
  int encoded_field_len;
} string_test_case[] = {{(char *)"", 0, reinterpret_cast<const uint8_t *>("\x0"
                                                                          ""),
                         1},
                        {(char *)"custom-key", 10, reinterpret_cast<const uint8_t *>("\xA"
                                                                                     "custom-key"),
                         11},
                        {(char *)"", 0, reinterpret_cast<const uint8_t *>("\x80"
                                                                          ""),
                         1},
                        {(char *)"custom-key", 10, reinterpret_cast<const uint8_t *>("\x88"
...
const static struct {
  ...
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::NEVERINDEX_LITERAL,
   reinterpret_cast<const uint8_t *>("\x10\x0a"
                                     ...
                                     "custom-header"),
   26},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::INDEXED_LITERAL, reinterpret_cast<const uint8_t *>("\x44\x0c"
                                                                                                              "/sample/path"),
   14},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::NOINDEX_LITERAL, reinterpret_cast<const uint8_t *>("\x04\x0c"
                                                                                                              "/sample/path"),
   14},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::NEVERINDEX_LITERAL, reinterpret_cast<const uint8_t *>("\x14\x0c"
                                                                                                                 "/sample/path"),
   14},
  {(char *)"password", (char *)"secret", 0, HpackField::INDEXED_LITERAL, reinterpret_cast<const uint8_t *>("\x40\x08"
                                                                                                           "password\x06"
                                                                                                           "secret"),
   17},
  {(char *)"password", (char *)"secret", 0, HpackField::NOINDEX_LITERAL, reinterpret_cast<const uint8_t *>("\x00\x08"
                                                                                                           "password\x06"
                                                                                                           "secret"),
   17},
  {(char *)"password", (char *)"secret", 0, HpackField::NEVERINDEX_LITERAL, reinterpret_cast<const uint8_t *>("\x10\x08"
                                                                                                              "password\x06"
                                                                                                              "secret"),
   17},
  // with Huffman Coding
