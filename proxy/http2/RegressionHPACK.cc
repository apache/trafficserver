...
const static struct {
  ...
  int prefix;
} integer_test_case[] = {{10, reinterpret_cast<uint8_t *>("\x0A"), 1, 5},
                         {1337, reinterpret_cast<uint8_t *>("\x1F\x9A\x0A"), 3, 5},
                         {42, reinterpret_cast<uint8_t *>("\x2A"), 1, 8}};
...
const static struct {
  ...
  uint8_t *encoded_field;
  int encoded_field_len;
} string_test_case[] = {{(char *)"", 0, reinterpret_cast<uint8_t *>("\x0"
                                                                    ""),
                         1},
                        {(char *)"custom-key", 10, reinterpret_cast<uint8_t *>("\xA"
                                                                               "custom-key"),
                         11},
                        {(char *)"", 0, reinterpret_cast<uint8_t *>("\x80"
                                                                    ""),
                         1},
                        {(char *)"custom-key", 10, reinterpret_cast<uint8_t *>("\x88"
...
const static struct {
  ...
  uint8_t *encoded_field;
  int encoded_field_len;
} indexed_test_case[] = {{2, (char *)":method", (char *)"GET", reinterpret_cast<uint8_t *>("\x82"), 1}};
...
const static struct {
  ...
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::INDEXED_LITERAL, reinterpret_cast<uint8_t *>("\x40\x0a"
                                                                                                              "custom-key\x0d"
                                                                                                              "custom-header"),
   26},
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::NOINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x00\x0a"
                                                                                                              "custom-key\x0d"
                                                                                                              "custom-header"),
   26},
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::NEVERINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x10\x0a"
                                                                                                                 "custom-key\x0d"
                                                                                                                 "custom-header"),
   26},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::INDEXED_LITERAL, reinterpret_cast<uint8_t *>("\x44\x0c"
                                                                                                        "/sample/path"),
   14},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::NOINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x04\x0c"
                                                                                                        "/sample/path"),
   14},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::NEVERINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x14\x0c"
                                                                                                           "/sample/path"),
   14},
  {(char *)"password", (char *)"secret", 0, HpackField::INDEXED_LITERAL, reinterpret_cast<uint8_t *>("\x40\x08"
                                                                                                     "password\x06"
                                                                                                     "secret"),
   17},
  {(char *)"password", (char *)"secret", 0, HpackField::NOINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x00\x08"
                                                                                                     "password\x06"
                                                                                                     "secret"),
   17},
  {(char *)"password", (char *)"secret", 0, HpackField::NEVERINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x10\x08"
                                                                                                        "password\x06"
                                                                                                        "secret"),
   17},
  // with Huffman Coding
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::INDEXED_LITERAL,
   reinterpret_cast<uint8_t *>("\x40"
  ...
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::NOINDEX_LITERAL,
   reinterpret_cast<uint8_t *>("\x00"
                               "\x88\x25\xa8\x49\xe9\x5b\xa9\x7d\x7f"
                               "\x89\x25\xa8\x49\xe9\x5a\x72\x8e\x42\xd9"),
   20},
  {(char *)"custom-key", (char *)"custom-header", 0, HpackField::NEVERINDEX_LITERAL,
   reinterpret_cast<uint8_t *>("\x10"
                               "\x88\x25\xa8\x49\xe9\x5b\xa9\x7d\x7f"
                               "\x89\x25\xa8\x49\xe9\x5a\x72\x8e\x42\xd9"),
   20},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::INDEXED_LITERAL,
   reinterpret_cast<uint8_t *>("\x44"
                               "\x89\x61\x03\xa6\xba\x0a\xc5\x63\x4c\xff"),
   11},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::NOINDEX_LITERAL,
   reinterpret_cast<uint8_t *>("\x04"
                               "\x89\x61\x03\xa6\xba\x0a\xc5\x63\x4c\xff"),
   11},
  {(char *)":path", (char *)"/sample/path", 4, HpackField::NEVERINDEX_LITERAL,
   reinterpret_cast<uint8_t *>("\x14"
                               "\x89\x61\x03\xa6\xba\x0a\xc5\x63\x4c\xff"),
   11},
  {(char *)"password", (char *)"secret", 0, HpackField::INDEXED_LITERAL, reinterpret_cast<uint8_t *>("\x40"
                                                                                                     "\x86\xac\x68\x47\x83\xd9\x27"
                                                                                                     "\x84\x41\x49\x61\x53"),
   13},
  {(char *)"password", (char *)"secret", 0, HpackField::NOINDEX_LITERAL, reinterpret_cast<uint8_t *>("\x00"
                                                                                                     "\x86\xac\x68\x47\x83\xd9\x27"
                                                                                                     "\x84\x41\x49\x61\x53"),
   13},
...
const static struct {
  uint8_t *encoded_field;
  int encoded_field_len;
} encoded_field_request_test_case[] = {{reinterpret_cast<uint8_t *>("\x40"
                                                                    "\x7:method"
                                                                    "\x3GET"
                                                                    "\x40"
                                                                    "\x7:scheme"
...
const static struct {
  ...
  {reinterpret_cast<uint8_t *>("\x48\x82"
                               "\x64\x02"
                               "\x58\x85"
                               "\xae\xc3\x77\x1a\x4b"
                               "\x61\x96"
                               ...
                               "\xd3"),
   54},
  {reinterpret_cast<uint8_t *>("\x48\x83"
                               "\x64\x0e\xff"
                               "\xc1"
                               "\xc0"
                               "\xbf"),
   8},
  {reinterpret_cast<uint8_t *>("\x88"
                               "\xc1"
                               "\x61\x96"
                               "\xd0\x7a\xbe\x94\x10\x54\xd4\x44\xa8\x20\x05\x95\x04\x0b\x81\x66"
