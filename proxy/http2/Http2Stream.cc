...
{
  Http2ErrorCode error = http2_decode_header_blocks(&_recv_header, (const uint8_t *)header_blocks, header_blocks_length,
                                                    nullptr, hpack_handle, _possible_trailing_header, maximum_table_size,
                                                    _outbound_flag);
