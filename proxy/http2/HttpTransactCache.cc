                                                             ...
                                                             MIMEField * content_field, MIMEField * cached_accept_field)
{
  ...
  //////////////////////////////////////////////////////////
  // loop over Accept-Charset elements, looking for match //
  //////////////////////////////////////////////////////////
...
CacheLookupHttpConfig::marshal(char *buf, int length)
{
  ...
  if ((length -= sizeof(ink32)) < 0)
    return -1;

  i32_tmp = (ink32) cache_enable_default_vary_headers;
  memcpy(p, &i32_tmp, sizeof(ink32));
  p += sizeof(ink32);
