...
tsapi const char *TS_HTTP_METHOD_COPY;
tsapi const char *TS_HTTP_METHOD_MOVE;
tsapi const char *TS_HTTP_METHOD_PROPFIND;
tsapi const char *TS_HTTP_METHOD_PROPPATCH;
tsapi const char *TS_HTTP_METHOD_LOCK;
tsapi const char *TS_HTTP_METHOD_UNLOCK;
tsapi const char *TS_HTTP_METHOD_MKCOL;
tsapi const char *TS_HTTP_METHOD_REPORT;
tsapi const char *TS_HTTP_METHOD_CHECKOUT;
...
tsapi int TS_HTTP_LEN_COPY;
tsapi int TS_HTTP_LEN_MOVE;
tsapi int TS_HTTP_LEN_PROPFIND;
tsapi int TS_HTTP_LEN_PROPPATCH;
tsapi int TS_HTTP_LEN_LOCK;
tsapi int TS_HTTP_LEN_UNLOCK;
tsapi int TS_HTTP_LEN_MKCOL;
tsapi int TS_HTTP_LEN_REPORT;
tsapi int TS_HTTP_LEN_CHECKOUT;
...
api_init()
{
  ...
  if (init) {
    ...
    TS_HTTP_METHOD_COPY = HTTP_METHOD_COPY;
    TS_HTTP_METHOD_MOVE = HTTP_METHOD_MOVE;
    TS_HTTP_METHOD_PROPFIND = HTTP_METHOD_PROPFIND;
    TS_HTTP_METHOD_PROPPATCH = HTTP_METHOD_PROPPATCH;
    TS_HTTP_METHOD_LOCK = HTTP_METHOD_LOCK;
    TS_HTTP_METHOD_UNLOCK = HTTP_METHOD_UNLOCK;
    TS_HTTP_METHOD_MKCOL = HTTP_METHOD_MKCOL;
    TS_HTTP_METHOD_REPORT = HTTP_METHOD_REPORT;
    TS_HTTP_METHOD_CHECKOUT = HTTP_METHOD_CHECKOUT;
    ...
    TS_HTTP_LEN_COPY = HTTP_LEN_COPY;
    TS_HTTP_LEN_MOVE = HTTP_LEN_MOVE;
    TS_HTTP_LEN_PROPFIND = HTTP_LEN_PROPFIND;
    TS_HTTP_LEN_PROPPATCH = HTTP_LEN_PROPPATCH;
    TS_HTTP_LEN_LOCK = HTTP_LEN_LOCK;
    TS_HTTP_LEN_UNLOCK = HTTP_LEN_UNLOCK;
    TS_HTTP_LEN_MKCOL = HTTP_LEN_MKCOL;
    TS_HTTP_LEN_REPORT = HTTP_LEN_REPORT;
    TS_HTTP_LEN_CHECKOUT = HTTP_LEN_CHECKOUT;
