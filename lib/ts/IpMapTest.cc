...
REGRESSION_TEST(IpMap_Basic)(RegressionTest* t, int, int* pstatus) { // UNUSED int atype
...
REGRESSION_TEST(IpMap_Unmark)(RegressionTest* t, int, int* pstatus) { // UNUSED int atype
  TestBox tb(t, pstatus);
  IpMap map;
//  ip_text_buffer ipb1, ipb2;
  void* const markA = reinterpret_cast<void*>(1);
...
REGRESSION_TEST(IpMap_Fill)(RegressionTest* t, int, int* pstatus) { // UNUSED int atype
  TestBox tb(t, pstatus);
  IpMap map;
  ip_text_buffer ipb1, ipb2;
