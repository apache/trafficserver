...
info_t methods[] = {
  ...
  {"COPY", "HTTP_METHOD_COPY", -1},
  {"MOVE", "HTTP_METHOD_MOVE", -1},
  {"PROPFIND", "HTTP_METHOD_PROPFIND", -1},
  {"PROPPATCH", "HTTP_METHOD_PROPPATCH", -1},
  {"LOCK", "HTTP_METHOD_LOCK", -1},
  {"UNLOCK", "HTTP_METHOD_UNLOCK", -1},
  {"MKCOL", "HTTP_METHOD_MKCOL", -1},
  {"REPORT", "HTTP_METHOD_REPORT", -1},
  {"CHECKOUT", "HTTP_METHOD_CHECKOUT", -1},
