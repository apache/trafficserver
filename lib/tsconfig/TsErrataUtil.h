...
namespace msg
{
  ...
  */
  ...
  /// @return @a err.
  Errata &log(Errata &err,       ///< Target errata.
  ...
  Errata &log(RvBase &rv,        ///< Return value.
              Errata::Code code, ///< Severity level.
              char const *text   ///< Message text.
              );
  /// printf style log to Errata.
  /// @return @a err.
  Errata &logf(Errata &err,        ///< Target errata.
               Errata::Id id,      ///< Message ID.
               Errata::Code code,  ///< Severity level.
  ...
  /// Use message ID 0.
  /// @return The @c Errata in @a rv.
  Errata &logf(RvBase &rv,         ///< Rv value.
               Errata::Code code,  ///< Severity level.
  ...
  /// Use message ID 0.
  /// @return @a err.
  Errata log(Errata::Code code, ///< Severity level.
             char const *text   ///< Message text.
             );
  /// Return an Errata populated with a printf style formatted string.
  /// Use message ID 0.
  /// @return @a err.
  Errata logf(Errata::Code code,  ///< Severity level.
              char const *format, ///< Message text.
              ...);
   ...
   */
  Errata log_errno(Errata::Code code, ///< Severity level.
                   char const *text   ///< Message text.
                   );
  /** Return an @c Errata based on @c errno.
      ...
      @return The new @c Errata.
   */
  Errata logf_errno(Errata::Code code,  ///< Severity code.
                    char const *format, ///< Format string.
  ...
  /** Add a message to an @a errata based on @c errno.
      ...
      @return @a errata.
   */
  Errata logf_errno(Errata &errata,     ///< Errata to use.
   ...
   */
  Errata logf_errno(RvBase &rv,         ///< Return value.
                    Errata::Code code,  ///< Severity code.
                    char const *format, ///< Format string.
                    ...                 ///< Arguments for @a format.
                    );
