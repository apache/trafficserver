...
int
tsconfigerror(yyscan_t lexer ATS_UNUSED, struct TsConfigHandlers *handlers, char const *text)
{
...
static const char *const yytname[] = {
  ...
  "value",       "literal",     "separator",   "path",           "path_open", "path_close", "path_item", "path_tag",   YY_NULLPTR};
#endif
...
yy_reduce_print(yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, yyscan_t lexer, struct TsConfigHandlers *handlers)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++) {
    ...
    yy_symbol_print(stderr, yystos[yyssp[yyi + 1 - yynrhs]], &(yyvsp[(yyi + 1) - (yynrhs)]), lexer, handlers);
    YYFPRINTF(stderr, "\n");
  }
}
