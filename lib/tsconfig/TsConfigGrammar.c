...
int tsconfigparse (void *lexer, struct TsConfigHandlers* handlers);
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, void *lexer, struct TsConfigHandlers* handlers)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (lexer);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, void *lexer, struct TsConfigHandlers* handlers)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, void *lexer, struct TsConfigHandlers* handlers)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, void *lexer, struct TsConfigHandlers* handlers)
{
  YYUSE (yyvaluep);
  YYUSE (lexer);
  YYUSE (handlers);
...
int
yyparse (void *lexer, struct TsConfigHandlers* handlers)
{
