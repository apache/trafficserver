...
{
       0,     0,     3,     5,     9,    11,    13,    14,    18,    22,
      23,    28,    32,    34,    36,    37,    41,    45,    47,    49,
      51,    53,    55,    57,    59,    60,    62,    66,    68,    70,
      72,    76,    78
};
...
{
      16,     0,    -1,    20,    -1,    18,    20,    19,    -1,     8,
      -1,     9,    -1,    -1,    20,    21,    29,    -1,    20,     1,
      29,    -1,    -1,     4,    14,    22,    27,    -1,    24,    26,
      25,    -1,     6,    -1,     7,    -1,    -1,    26,    27,    29,
      -1,    26,     1,    29,    -1,    28,    -1,    23,    -1,    17,
      -1,    30,    -1,     3,    -1,     4,    -1,     5,    -1,    -1,
      13,    -1,    31,    33,    32,    -1,    10,    -1,    11,    -1,
      34,    -1,    33,    12,    34,    -1,     4,    -1,     5,    -1
};
...
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, lexer, handlers)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    yyscan_t lexer;
...
#else
static void
yy_reduce_print (yyvsp, yyrule, lexer, handlers)
    YYSTYPE *yyvsp;
    int yyrule;
    yyscan_t lexer;
    struct TsConfigHandlers* handlers;
...
#else
static void
yydestruct (yymsg, yytype, yyvaluep, lexer, handlers)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    yyscan_t lexer;
