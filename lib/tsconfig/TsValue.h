...
namespace config
{
  ...
  public:
    ...
    */
    ...
    public:
      ...
      */
      Rv<Result> parse(ConstBuffer *cbuff = 0 ///< [out] Parsed path element.
                       );
  ...
  */
  ...
  Value::item()
  {
    return this->hasValue() ? &(_config._table[_vidx]) : 0;
  }
  ...
  {
    this->instance()->_elements.push_back(ConstBuffer(0, index));
    return *this;
  }
  inline size_t
  Path::count() const
