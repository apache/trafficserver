...
public:
   ...
   */
  bool
  init(const std::string &file, bool add_timestamp = true, bool rename_file = true, LogLevel level = LOG_LEVEL_INFO,
  ...
  MOCK_METHOD1(setRollingIntervalSeconds, void(int));

  /**
   * @return the number of seconds between log rolls.
   */
  // int getRollingIntervalSeconds() const;
  MOCK_CONST_METHOD0(getRollingIntervalSeconds, int());
  ...
  MOCK_METHOD1(setLogLevel, void(Logger::LogLevel));
  ...
  MOCK_CONST_METHOD0(getLogLevel, Logger::LogLevel());
