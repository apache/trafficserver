...
public:
  ...
  MOCK_METHOD1(setErrorBody, void (const std::string&));
  ...
  MOCK_CONST_METHOD0(getClientAddress, const sockaddr* ());
  ...
  MOCK_CONST_METHOD0(getIncomingAddress, const sockaddr* ());
  ...
  MOCK_CONST_METHOD0(getServerAddress, const sockaddr* ());
  ...
  MOCK_CONST_METHOD0(getNextHopAddress, const sockaddr* ());
  ...
  MOCK_METHOD1(setIncomingPort, bool (uint16_t));
  ...
  MOCK_METHOD1(setServerAddress, bool (const sockaddr *));
  ...
  MOCK_CONST_METHOD0(isInternalRequest, bool ());
  ...
  MOCK_METHOD0(getClientRequest, ClientRequest& ());
  ...
  MOCK_METHOD0(getServerRequest, Request& ());
  ...
  MOCK_METHOD0(getServerResponse, Response& ());
  ...
  MOCK_METHOD1(setCacheUrl, bool (const std::string&));
  ...
  MOCK_METHOD2(setTimeout, void (TimeoutType, int));
  ...
  MOCK_CONST_METHOD0(getAtsHandle, void* ());
  ...
  MOCK_METHOD1(addPlugin, void (TransactionPlugin *));
  ...
  MOCK_METHOD0(getServerResponseBodySize, size_t ());
  ...
  MOCK_METHOD0(getServerResponseHeaderSize, size_t ());
  ...
  MOCK_METHOD0(getClientResponseBodySize, size_t ());
  ...
  MOCK_METHOD0(getClientResponseHeaderSize, size_t ());

  /**
   * Redirect the transaction a different @a url.
   */
  //void redirectTo(std::string const& url);
  MOCK_METHOD1(redirectTo, void (std::string&));
...
private:
  ...
  MOCK_METHOD0(initServerRequest, void ());
  ...
  MOCK_METHOD0(initServerResponse, void ());
  ...
  MOCK_METHOD0(initClientResponse, void ());
  ...
  MOCK_CONST_METHOD0(getPlugins, const std::list<TransactionPlugin *> ());
