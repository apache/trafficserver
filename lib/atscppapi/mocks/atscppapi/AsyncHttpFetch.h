...
public:
  ...
  AsyncHttpFetch(const std::string &url_str, StreamingFlag streaming_flag,
	...
	{
	  std::cout << "AsyncHttpFetch constructor" << std::endl;
	}
  ...
  MOCK_CONST_METHOD0(getResult, Result() );
  ...
  MOCK_CONST_METHOD0(getRequestUrl, const Url& () );

  /**
   * @return Non-mutable reference to the request body.
   */
  //const std::string &getRequestBody() const;
  MOCK_CONST_METHOD0(getRequestBody, const std::string& () );
  ...
  MOCK_CONST_METHOD0(getResponse, const Response& () );
  ...
  MOCK_CONST_METHOD2(getResponseBody, void(const void*&, size_t&) );
...
private:
  MOCK_METHOD4(init, void(const std::string &url_str, HttpMethod http_method, const std::string &request_body,
