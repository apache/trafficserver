...
static const RecordElement RecordsConfig[] =
{
  ...
  ,
  {RECT_CONFIG, "proxy.config.http.parent_proxy.file", RECD_STRING, PARENT_CONF_FILENAME, RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.socks.socks_config_file", RECD_STRING, SOCKS_CONF_FILENAME, RECU_RESTART_TS, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  //#
  //##############################################################################
  {RECT_CONFIG, "proxy.config.cache.control.filename", RECD_STRING, CACHE_CONF_FILENAME, RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  {RECT_CONFIG, "proxy.config.cache.ip_allow.filename", RECD_STRING, IPALLOW_CONF_FILENAME, RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  {RECT_CONFIG, "proxy.config.cache.hosting_filename", RECD_STRING, HOSTING_CONF_FILENAME, RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  {RECT_CONFIG, "proxy.config.cache.volume_filename", RECD_STRING, VOLUME_CONF_FILENAME, RECU_RESTART_TS, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.dns.splitdns.filename", RECD_STRING, SPLITDNS_CONF_FILENAME, RECU_NULL, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.log.config.filename", RECD_STRING, LOGGING_CONF_FILENAME, RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.url_remap.filename", RECD_STRING, REMAP_CONF_FILENAME, RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.ssl.server.multicert.filename", RECD_STRING, MULTICERT_CONF_FILENAME, RECU_RESTART_TS, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
...
,
  {RECT_CONFIG, "proxy.config.ssl.servername.filename", RECD_STRING, SNI_CONF_FILENAME, RECU_RESTART_TS, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
