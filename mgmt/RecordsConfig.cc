...
static const RecordElement RecordsConfig[] =
{
  ...
  ,
  {RECT_NODE, "proxy.node.cache.bytes_total", RECD_COUNTER, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  {RECT_NODE, "proxy.node.cache.bytes_total_mb", RECD_COUNTER, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  {RECT_NODE, "proxy.node.cache.bytes_free", RECD_COUNTER, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  {RECT_NODE, "proxy.node.cache.bytes_free_mb", RECD_COUNTER, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  ...
  ,
  {RECT_NODE, "proxy.process.ssl.total_success_handshake_count_in", RECD_COUNTER, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
