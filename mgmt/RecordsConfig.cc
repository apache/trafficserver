...
static const RecordElement RecordsConfig[] =
{
  ...
  ,
  {RECT_CONFIG, "proxy.config.http.transaction_no_activity_timeout_out_ms", RECD_INT, "0", RECU_DYNAMIC, RR_NULL, RECC_STR, "^[0-9]+$", RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.http.transaction_active_timeout_out_ms", RECD_INT, "0", RECU_DYNAMIC, RR_NULL, RECC_STR, "^[0-9]+$", RECA_NULL}
  ,
