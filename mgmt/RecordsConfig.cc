...
RecordElement RecordsConfig[] = {
  ...
  ,
  {RECT_CONFIG, "proxy.config.cache.permit.pinning", RECD_INT, "1", RECU_DYNAMIC, RR_NULL, RECC_INT, "[0-1]", RECA_NULL}
  ,
  ...
  //#
  //############
  {RECT_CONFIG, "proxy.config.spdy.client.max_concurrent_streams", RECD_INT, "1000", RECU_DYNAMIC, RR_NULL, RECC_INT, NULL, RECA_NULL},
