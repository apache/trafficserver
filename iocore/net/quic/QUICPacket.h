...
public:
  ...
  [[deprecated]] static QUICConnectionId destination_connection_id(const uint8_t *packet);
  [[deprecated]] static QUICConnectionId source_connection_id(const uint8_t *packet);
