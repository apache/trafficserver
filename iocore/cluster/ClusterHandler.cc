...
{
  // Set global time
  current_time = Thread::ink_get_hrtime();
  ...
  for (;;) {
...
#endif
        read.msg.clear();
        read.start_time = Thread::ink_get_hrtime();
    ...
    case ClusterState::READ_COMPLETE:
      ///////////////////////////////////////////////
      {
        ...
        _n_read_complete++;
#endif
        ink_hrtime rdmsg_end_time = Thread::ink_get_hrtime();
...
#endif
        write.msg.clear();
        write.last_time = Thread::ink_get_hrtime();
...
// Move required data into the message header
    ...
    case ClusterState::WRITE_COMPLETE:
      ///////////////////////////////////////////////
      {
        ...
        ink_hrtime curtime = Thread::ink_get_hrtime();
