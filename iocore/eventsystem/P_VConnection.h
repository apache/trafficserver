...
vc_do_io_write(VConnection * vc, Continuation * cont, int64 nbytes, MIOBuffer * buf, int64 offset)
{
...
TS_INLINE VIO *
VConnection::do_io(int op, Continuation * c, int64 nbytes, MIOBuffer * cb, int data)
{
  switch (op) {
  case VIO::READ:
