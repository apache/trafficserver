...
public:
  ...
  MIOBufferWriter &write(char c) override { return write(&c, 1); }
  ...
  //
  size_t capacity() const override { return(~size_t(0)); }

  size_t extent() const override { return _numWritten; }
...
private:
  ...
  virtual void addBlock() { _miob.add_block(); }
};
