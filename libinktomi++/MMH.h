...
int inkcoreapi ink_code_incr_MMH_final(char *sixteen_byte_hash_pointer, MMH_CTX * context);
...
struct MMH
{
  ...
  MMH & operator =(unsigned char *MMH) {
    return (loadFromBuffer((char *) MMH));
  }
  ...
  bool operator==(const MMH & MMH) const
  {
    return b[0] == MMH.b[0] && b[1] == MMH.b[1];
  }
  MMH()
  {
    b[0] = 0;
...
#include "INK_MD5.h"
#define MMH INK_MD5
#define MMH_CTX INK_DIGEST_CTX
#define ink_code_incr_MMH_init ink_code_incr_md5_init
#define ink_code_incr_MMH_update ink_code_incr_md5_update
#define ink_code_incr_MMH_final ink_code_incr_md5_final
#define ink_code_MMH ink_code_md5
