...
#
tr.MakeCurlCommand('--verbose --header "Host: mYhOsT.teSt" hTtP://loCalhOst:{}/'.format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0

tr = Test.AddTestRun()
tr.MakeCurlCommand('--verbose --proxy localhost:{} http://mYhOsT.teSt/xYz'.format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
