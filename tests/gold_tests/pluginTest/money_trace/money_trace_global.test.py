...
tr.MakeCurlCommand(curl_and_args + ' http://ats/path -H "MoneyTrace: ' + clientvalue + '"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://ats/path -H "Skip-Global-MoneyTrace: true"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://ats/path', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
