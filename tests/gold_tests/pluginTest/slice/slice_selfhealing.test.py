...
tr.MakeCurlCommand(curl_and_args + ' http://crr/second -r 0-2 -H "uuid: etagnew-0"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://crr/second -r 3-5 -H "uuid: etagold-1"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/second -r 3- -H "uuid: etagnew-1"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/second', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://crr/reference -r 0-2 -H "uuid: etagold-0"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://crr/reference -r 3-5 -H "uuid: etagnew-1"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
ps.Streams.stderr = "gold/bb.gold"
ps.Streams.stdout.Content = Testers.ContainsExpression("etagnew", "expected etagnew")
tr.StillRunningAfter = ts
...
ps = tr.Processes.Default
tr.MakeCurlCommand(
    curl_and_args + ' http://slice/reference -r 3- -H "uuid: etagnew-0" -w "SENT: \'%{size_download}\'"',
...
tr = Test.AddTestRun("Request full healed slice")
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/reference', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
ps.Streams.stderr.Content = Testers.ContainsExpression("bbbbb", "expected bbbbb content")
ps.Streams.stdout.Content = Testers.ContainsExpression("etagnew", "expected etagnew")
tr.StillRunningAfter = ts
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/code200 -r 3-5 -H "uuid: code200"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/assetgone -r 0-2 -H "uuid: assetgone-0"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
ps.Streams.stderr = "gold/aaa.gold"
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/assetgone', uds_path=ts.Variables.uds_path)
...
ps = tr.Processes.Default
tr.MakeCurlCommand(
    curl_and_args + f' http://crrhdr/second-custom -r 3-5 -H "uuid: etagold-custom-1" -H "crr-foo: {edate}"',
    uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
ps.Streams.stderr = "gold/aa.gold"
...
ps = tr.Processes.Default
tr.MakeCurlCommand(
    curl_and_args + ' http://slicehdr/second-custom -r 3- -H "uuid: etagnew-custom-1"', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
ps.Streams.stderr = "gold/bb.gold"
