...
tr.CurlCommand(curl_and_args + ' http://ats/etag')
...
ps = tr.Processes.Default
tr.CurlCommand(curl_and_args + ' http://ats/lastmodified')
# ps.ReturnCode = 0 # curl will return fail status
ps.Streams.stderr = "gold_error/contents.stderr.gold"
ps.Streams.stdout.Content = Testers.ContainsExpression("200 OK", "expected 200 OK response")
tr.StillRunningAfter = ts
...
ps = tr.Processes.Default
tr.CurlCommand(curl_and_args + ' http://ats/crr')
# ps.ReturnCode = 0 # curl will return fail status
ps.Streams.stderr = "gold_error/contents.stderr.gold"
ps.Streams.stdout.Content = Testers.ContainsExpression("200 OK", "expected 200 OK response")
tr.StillRunningAfter = ts
...
ps = tr.Processes.Default
tr.CurlCommand(curl_and_args + ' http://ats/internal404')
# ps.ReturnCode = 0 # curl will return fail status
ps.Streams.stderr = "gold_error/contents.stderr.gold"
ps.Streams.stdout.Content = Testers.ContainsExpression("200 OK", "expected 200 OK response")
tr.StillRunningAfter = ts
