...
tr.MakeCurlCommand(curl_and_args + ' http://slice/small', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' -r 1-2 http://slice/small', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
...
ps = tr.Processes.Default
tr.MakeCurlCommand(curl_and_args + ' http://slice/large', uds_path=ts.Variables.uds_path)
ps.ReturnCode = 0
