...
for i in list(range(3594967639391, 3594967639391 + 3)):
    request_header = {
        "headers": f"GET /texts/demo-{i}.txt HTTP/1.1\r\n"
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(f'--verbose --proxy 127.0.0.1:{ts.Variables.port} http://domain.in/texts/demo-3594967639391.txt', ts=ts)
tr.Processes.Default.ReturnCode = 0
