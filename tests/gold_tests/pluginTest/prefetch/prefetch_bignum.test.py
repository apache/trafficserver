...
vals = [
    "3842948374928374982374982374", "3842948374928374982374982375", "3842948374928374982374982376", "3842948374928374982374982377"
]
for i in vals:
    request_header = {
        "headers":
...
tr = Test.AddTestRun()
tr.CurlCommand(f'--verbose --proxy 127.0.0.1:{ts.Variables.port} http://domain.in/texts/demo-3842948374928374982374982374.txt')
tr.Processes.Default.ReturnCode = 0
