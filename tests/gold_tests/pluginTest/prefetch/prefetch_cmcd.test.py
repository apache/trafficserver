...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    f"--verbose --proxy 127.0.0.1:{ts0.Variables.port} http://ts0/tests/{asset_name}", uds_path=ts0.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
...
tr.DelayStart = 1
tr.MakeCurlCommand(
    f"--verbose --proxy 127.0.0.1:{ts0.Variables.port} http://ts0/tests/{asset_name} -H \'{pf_header}\'",
    uds_path=ts0.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0

# fetch the prefetched asset (only cached on ts1)
tr = Test.AddTestRun()
tr.DelayStart = 1
tr.MakeCurlCommand(f"--verbose --proxy 127.0.0.1:{ts0.Variables.port} http://ts0/tests/{pf_name}", uds_path=ts0.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    f"--verbose --proxy 127.0.0.1:{ts0.Variables.port} \'http://ts0/tests/{query_pf_name}\'", uds_path=ts0.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0

# ensure root path prefetch works
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    f"--verbose --proxy 127.0.0.1:{ts0.Variables.port} \'http://ts0/{root_name}\' -H \'{root_header}\'",
    uds_path=ts0.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    f"--verbose --proxy 127.0.0.1:{ts0.Variables.port} \'http://ts0/{crr_name}\' -H \'{crr_header}\'",
    uds_path=ts0.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
