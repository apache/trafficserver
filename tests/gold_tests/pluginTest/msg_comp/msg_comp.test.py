...
Test.PrepareTestPlugin(os.path.join(Test.Variables.AtsTestPluginsDir, 'test_msg_comp.so'), ts)
...
tr.Processes.Default.Command = (
    r"printf 'GET /argh HTTP/1.1\r\n" +
    r"Connection: close\r\n" +
    r"Host: one\r\n" +
    r"X-Crap: one, two, three\r\n" +
    r"X-Crap: four\r\n\r\n'" +
    " | nc localhost {}".format(ts.Variables.port)
)
