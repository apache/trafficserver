...
ts.Disk.records_config.update(
    {
        ...
        'proxy.config.crash_log_helper': '/home/dmeden/code/git/trafficserver/build/_sandbox/txn-debug/ts-debug-enabled/bin/traffic_crashlog',
    }
)
...
ts.Disk.records_config.update(
    {
        'proxy.config.diags.debug.enabled': 1,
        'proxy.config.diags.debug.tags': 'txn_box',
        'proxy.config.crash_log_helper': '/home/dmeden/code/git/trafficserver/build/_sandbox/txn-debug/ts-debug-disabled/bin/traffic_crashlog',
    }
)
