...
ts.Disk.File(Test.RunDirectory +"/existsconfig.txt", exists=False, id="config1")
ts.Disk.config1.WriteOn(config1)

ts.Disk.remap_config.AddLine(
    'map http://www.example.com/magic http://shouldnothit.com @plugin=cookie_remap.so @pparam={0}/existsconfig.txt'.format(Test.RunDirectory)
)
