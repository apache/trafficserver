...
for i in range(3):
    ...
    tr.MakeCurlCommand(curl(ts, i, 'gzip, deflate, sdch, br', out_path), uds_path=ts.Variables.uds_path)
    ...
    tr.Processes.Default.ReturnCode = 0
    out_path = get_out_path()
    tr.MakeCurlCommand(curl(ts, i, "gzip", out_path), uds_path=ts.Variables.uds_path)
    ...
    tr.Processes.Default.ReturnCode = 0
    out_path = get_out_path()
    tr.MakeCurlCommand(curl(ts, i, "br", out_path), uds_path=ts.Variables.uds_path)
    ...
    tr.Processes.Default.ReturnCode = 0
    out_path = get_out_path()
    tr.MakeCurlCommand(curl(ts, i, "deflate", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, "gzip;q=0.666", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, "gzip;q=0.666x", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, "gzip;q=0.0", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, "gzip;q=-0.1", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, "aaa, gzip;q=0.666, bbb", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, " br ; q=0.666, bbb", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl(ts, 0, "aaa, gzip;q=0.666 , ", out_path), uds_path=ts.Variables.uds_path)
...
tr.Processes.Default.ReturnCode = 0
out_path = get_out_path()
tr.MakeCurlCommand(curl_post(ts, 3, "gzip", out_path), uds_path=ts.Variables.uds_path)
