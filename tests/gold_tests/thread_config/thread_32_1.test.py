...
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Streams.stdout = 'gold/thread_32_1.gold'
tr.Processes.Default.Streams.stdout += Testers.ExcludesExpression('\[ET\_NET 32\]', 'there should be more than 32 threads')
tr.Processes.Default.Streams.stdout += Testers.ExcludesExpression('\[ACCEPT 1\:', 'there should be more than 1 threads')
