...
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Streams.stdout = 'gold/thread_100_0.gold'
tr.Processes.Default.Streams.stdout += Testers.ExcludesExpression('\[ET\_NET 100\]', 'there should be more than 100 threads')
tr.Processes.Default.Streams.stdout += Testers.ExcludesExpression('\[ACCEPT 0\:', 'there should be more than 0 threads')
