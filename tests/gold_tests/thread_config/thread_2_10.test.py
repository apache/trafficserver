...
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Streams.stdout = 'gold/thread_2_10.gold'
tr.Processes.Default.Streams.stdout += Testers.ExcludesExpression('\[ET\_NET 2\]', 'there should be more than 2 threads')
