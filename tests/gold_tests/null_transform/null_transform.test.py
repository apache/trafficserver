...
ts.Disk.records_config.update({
    ...
    'proxy.config.diags.debug.tags': 'null-transform'
})
...
tr = Test.AddTestRun()
tr.Processes.Default.Command = 'curl --proxy 127.0.0.1:{0} "http://www.example.com" --verbose -H "Proxy-Connection: keep-alive"'.format(ts.Variables.port)
