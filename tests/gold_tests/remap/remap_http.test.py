...
# redirect result
tr = Test.AddTestRun()
tr.MakeCurlCommand(' --proxy 127.0.0.1:{0} "http://test3.com" --verbose'.format(ts.Variables.port), uds_path=ts.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    ' --proxy 127.0.0.1:{0} "http://test4.com" --header "Referer: persia.com" --verbose'.format(ts.Variables.port),
    uds_path=ts.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    ' --proxy 127.0.0.1:{0} "http://test4.com" --header "Referer: monkey.com" --verbose'.format(ts.Variables.port),
    uds_path=ts.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    ' --proxy 127.0.0.1:{0} "http://test4.com" --header "Referer: www.persia.com" --verbose'.format(ts.Variables.port),
    uds_path=ts.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Streams.stderr = "gold/remap-referer-hit.gold"
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    ' --proxy 127.0.0.1:{0} "http://testDNS.com" --verbose'.format(ts.Variables.port), uds_path=ts.Variables.uds_path)
tr.Processes.Default.ReturnCode = 0
