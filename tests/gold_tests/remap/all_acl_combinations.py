...
all_acl_combinations = [
    ...
    [ 56,  "ip_only",       "",                          "@action=allow @method=GET",  ALLOW_GET_AND_POST, 200, 403, ],
    [ 57,  "ip_only",       "",                          "@action=allow @method=GET",  ALLOW_GET,          200, 403, ],
    [ 58,  "ip_only",       "",                          "@action=allow @method=GET",  DENY_GET,           200, 403, ],
    [ 59,  "ip_only",       "",                          "@action=allow @method=GET",  DENY_GET_AND_POST,  200, 403, ],
    [ 60,  "ip_only",       "",                          "@action=deny  @method=GET",  ALLOW_GET_AND_POST, 403, 200, ],
    [ 61,  "ip_only",       "",                          "@action=deny  @method=GET",  ALLOW_GET,          403, 200, ],
    [ 62,  "ip_only",       "",                          "@action=deny  @method=GET",  DENY_GET,           403, 200, ],
    [ 63,  "ip_only",       "",                          "@action=deny  @method=GET",  DENY_GET_AND_POST,  403, 200, ],
    [ 64,  "ip_only",       "@action=allow @method=GET", "",                           ALLOW_GET_AND_POST, 200, 403, ],
    [ 65,  "ip_only",       "@action=allow @method=GET", "",                           ALLOW_GET,          200, 403, ],
    [ 66,  "ip_only",       "@action=allow @method=GET", "",                           DENY_GET,           200, 403, ],
    [ 67,  "ip_only",       "@action=allow @method=GET", "",                           DENY_GET_AND_POST,  200, 403, ],
    [ 68,  "ip_only",       "@action=allow @method=GET", "@action=allow @method=GET",  ALLOW_GET_AND_POST, 200, 403, ],
    [ 69,  "ip_only",       "@action=allow @method=GET", "@action=allow @method=GET",  ALLOW_GET,          200, 403, ],
    [ 70,  "ip_only",       "@action=allow @method=GET", "@action=allow @method=GET",  DENY_GET,           200, 403, ],
    [ 71,  "ip_only",       "@action=allow @method=GET", "@action=allow @method=GET",  DENY_GET_AND_POST,  200, 403, ],
    [ 72,  "ip_only",       "@action=allow @method=GET", "@action=deny  @method=GET",  ALLOW_GET_AND_POST, 200, 403, ],
    [ 73,  "ip_only",       "@action=allow @method=GET", "@action=deny  @method=GET",  ALLOW_GET,          200, 403, ],
    [ 74,  "ip_only",       "@action=allow @method=GET", "@action=deny  @method=GET",  DENY_GET,           200, 403, ],
    [ 75,  "ip_only",       "@action=allow @method=GET", "@action=deny  @method=GET",  DENY_GET_AND_POST,  200, 403, ],
    [ 76,  "ip_only",       "@action=deny  @method=GET", "",                           ALLOW_GET_AND_POST, 403, 200, ],
    [ 77,  "ip_only",       "@action=deny  @method=GET", "",                           ALLOW_GET,          403, 200, ],
    [ 78,  "ip_only",       "@action=deny  @method=GET", "",                           DENY_GET,           403, 200, ],
    [ 79,  "ip_only",       "@action=deny  @method=GET", "",                           DENY_GET_AND_POST,  403, 200, ],
    [ 80,  "ip_only",       "@action=deny  @method=GET", "@action=allow @method=GET",  ALLOW_GET_AND_POST, 403, 200, ],
    [ 81,  "ip_only",       "@action=deny  @method=GET", "@action=allow @method=GET",  ALLOW_GET,          403, 200, ],
    [ 82,  "ip_only",       "@action=deny  @method=GET", "@action=allow @method=GET",  DENY_GET,           403, 200, ],
    [ 83,  "ip_only",       "@action=deny  @method=GET", "@action=allow @method=GET",  DENY_GET_AND_POST,  403, 200, ],
    [ 84,  "ip_only",       "@action=deny  @method=GET", "@action=deny  @method=GET",  ALLOW_GET_AND_POST, 403, 200, ],
    [ 85,  "ip_only",       "@action=deny  @method=GET", "@action=deny  @method=GET",  ALLOW_GET,          403, 200, ],
    [ 86,  "ip_only",       "@action=deny  @method=GET", "@action=deny  @method=GET",  DENY_GET,           403, 200, ],
    [ 87,  "ip_only",       "@action=deny  @method=GET", "@action=deny  @method=GET",  DENY_GET_AND_POST,  403, 200, ],
]
# yapf: enable
