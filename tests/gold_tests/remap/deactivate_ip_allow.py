...
deactivate_ip_allow_combinations = [
    ...
    [ 10,  "legacy",  "@action=allow @method=GET", "", False, ALLOW_GET_AND_POST, 200, 200,   ],
    [ 11,  "legacy",  "@action=allow @method=GET", "", False, ALLOW_GET,          200, 403,   ],
    [ 12,  "legacy",  "@action=allow @method=GET", "", False, DENY_GET,           200, 200,   ],
    ...
    [ 15,  "legacy",  "@action=allow @method=GET", "", True,  ALLOW_GET_AND_POST, 200, 200,   ],
    [ 16,  "legacy",  "@action=allow @method=GET", "", True,  ALLOW_GET,          200, 200,   ],
    [ 17,  "legacy",  "@action=allow @method=GET", "", True,  DENY_GET,           200, 200,   ],
    [ 18,  "legacy",  "@action=allow @method=GET", "", True,  DENY_GET_AND_POST,  200, 200,   ],
    [ 19,  "legacy",  "@action=allow @method=GET", "", True,  DENY_ALL,           200, 200,   ],
    ...
    [ 30,  "legacy",  "@action=add_allow @method=GET", "", False, ALLOW_GET_AND_POST, 200, 200,   ],
    [ 31,  "legacy",  "@action=add_allow @method=GET", "", False, ALLOW_GET,          200, 403,   ],
    [ 32,  "legacy",  "@action=add_allow @method=GET", "", False, DENY_GET,           200, 200,   ],
    ...
    [ 35,  "legacy",  "@action=add_allow @method=GET", "", True,  ALLOW_GET_AND_POST, 200, 200,   ],
    [ 36,  "legacy",  "@action=add_allow @method=GET", "", True,  ALLOW_GET,          200, 200,   ],
    [ 37,  "legacy",  "@action=add_allow @method=GET", "", True,  DENY_GET,           200, 200,   ],
    [ 38,  "legacy",  "@action=add_allow @method=GET", "", True,  DENY_GET_AND_POST,  200, 200,   ],
    [ 39,  "legacy",  "@action=add_allow @method=GET", "", True,  DENY_ALL,           200, 200,   ],
    [ 40,  "legacy",  "@action=add_deny  @method=GET", "", False, ALLOW_GET_AND_POST, 403, 200,   ],
    [ 41,  "legacy",  "@action=add_deny  @method=GET", "", False, ALLOW_GET,          403, 403,   ],
    [ 42,  "legacy",  "@action=add_deny  @method=GET", "", False, DENY_GET,           403, 200,   ],
    [ 43,  "legacy",  "@action=add_deny  @method=GET", "", False, DENY_GET_AND_POST,  403, 403,   ],
