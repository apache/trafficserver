...
ts.Disk.remap_config.AddLine(
    'map http://cdn.example.com/ http://origin.example.com/ @plugin=conf_remap.so @pparam={file}'.format(file=os.path.join(ts.RunDirectory, 'ts/config/mysterio.config'))
)

ts.Disk.mysterio_config.AddLine(
