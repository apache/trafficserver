...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bob.bar.com:{0}:127.0.0.1' https://bob.bar.com:{0}/case1".format(ts.Variables.ssl_port))
...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bob.foo.com:{0}:127.0.0.1' https://bob.foo.com:{0}/case1".format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 35
...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bar.com:{0}:127.0.0.1' https://bar.com:{0}/case1".format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 0
