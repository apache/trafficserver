...
tr.StillRunningAfter = server
tr.MakeCurlCommand(
    "--tls-max 1.2 -k --cert ./signed-bob-bar.pem --key ./signed-bar.key --resolve 'bob.bar.com:{0}:127.0.0.1' https://bob.bar.com:{0}/case1".format(
        ts.Variables.ssl_port
    ),
    ts=ts,
)
...
tr.StillRunningAfter = server
tr.MakeCurlCommand(
    "--tls-max 1.2 -k --cert ./server.pem --key ./server.key --resolve 'bob.bar.com:{0}:127.0.0.1' https://bob.bar.com:{0}/case1".format(
        ts.Variables.ssl_port
    ),
    ts=ts,
)
...
tr.StillRunningAfter = server
tr.MakeCurlCommand(
    "--tls-max 1.2 -k --cert ./signed-bob-foo.pem --key ./signed-foo.key --resolve 'bob.foo.com:{0}:127.0.0.1' https://bob.foo.com:{0}/case1".format(
        ts.Variables.ssl_port
    ),
    ts=ts,
)
...
tr.StillRunningAfter = server
tr.MakeCurlCommand(
    "--tls-max 1.2 -k --cert ./server.pem --key ./server.key --resolve 'bob.foo.com:{0}:127.0.0.1' https://bob.foo.com:{0}/case1".format(
        ts.Variables.ssl_port
    ),
    ts=ts,
)
...
tr.StillRunningAfter = server
tr.MakeCurlCommand(
    "--tls-max 1.2 -k --cert ./signed-bar.pem --key ./signed-bar.key --resolve 'bar.com:{0}:127.0.0.1' https://bar.com:{0}/case1".format(
        ts.Variables.ssl_port
    ),
    ts=ts,
)
