...
tr.CurlCommand('-k -H \"host: foo.com\"  http://127.0.0.1:{0}/basic'.format(ts.Variables.port))
tr.ReturnCode = 0
...
tr2.CurlCommand("-k -H \"host: bar.com\"  http://127.0.0.1:{0}/basic".format(ts.Variables.port))
tr2.ReturnCode = 0
...
tr2.CurlCommand("-k -H \"host: random.com\"  http://127.0.0.1:{0}/basic".format(ts.Variables.port))
tr2.ReturnCode = 0
tr2.StillRunningAfter = server
tr2.StillRunningAfter = ts
...
tr3.CurlCommand("-k -H \"host: foo.com\"  http://127.0.0.1:{0}/override".format(ts.Variables.port))
tr3.ReturnCode = 0
...
tr4.CurlCommand("-k -H \"host: bad_bar.com\"  http://127.0.0.1:{0}/overridedisabled".format(ts.Variables.port))
tr4.ReturnCode = 0
...
tr5.CurlCommand("-k -H \"host: bar.com\"  http://127.0.0.1:{0}/overridesignature".format(ts.Variables.port))
tr5.ReturnCode = 0
...
tr6.CurlCommand("-k -H \"host: bar.com\"  http://127.0.0.1:{0}/overrideenforced".format(ts.Variables.port))
tr6.ReturnCode = 0
# Should fail
...
tr.CurlCommand("-k -H \"host: foo.com\"  http://127.0.0.1:{0}/snipolicybarremap".format(ts.Variables.port))
tr.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
...
tr.CurlCommand("-k -H \"host: foo.com\"  http://127.0.0.1:{0}/snipolicybarhost".format(ts.Variables.port))
tr.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
...
tr.CurlCommand("-k --resolve foo.com:{0}:127.0.0.1 https://foo.com:{0}/snipolicybarservername".format(ts.Variables.ssl_port))
tr.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
tr.Processes.Default.Streams.stdout = Testers.ContainsExpression("Could not connect", "Curl attempt should fail")
...
tr.CurlCommand("-k -H \"host: bar.com\"  http://127.0.0.1:{0}/snipolicyfooremap".format(ts.Variables.port))
tr.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
tr.Processes.Default.Streams.stdout = Testers.ContainsExpression("Could not connect", "Curl attempt should fail")
...
tr.CurlCommand("-k -H \"host: bar.com\"  http://127.0.0.1:{0}/snipolicyfoohost".format(ts.Variables.port))
tr.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
tr.Processes.Default.Streams.stdout = Testers.ExcludesExpression("Could not connect", "Curl attempt should succeed")
...
tr.CurlCommand("-k --resolve bar.com:{0}:127.0.0.1 https://bar.com:{0}/snipolicyfooservername".format(ts.Variables.ssl_port))
tr.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
tr.Processes.Default.Streams.stdout = Testers.ExcludesExpression("Could not connect", "Curl attempt should succeed")
