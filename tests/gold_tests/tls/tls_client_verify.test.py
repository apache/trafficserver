...
tr.CurlCommand("--tls-max 1.2 -k --resolve 'foo.com:{0}:127.0.0.1' https://foo.com:{0}/case1".format(ts.Variables.ssl_port))
...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bob.bar.com:{0}:127.0.0.1' https://bob.bar.com:{0}/case4".format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 0
...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bob.foo.com:{0}:127.0.0.1' https://bob.foo.com:{0}/case7".format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Streams.All = Testers.ExcludesExpression("alert", "TLS handshake should succeed")
...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bar.com:{0}:127.0.0.1' https://bar.com:{0}/case10".format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 35
...
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
tr.CurlCommand("--tls-max 1.2 -k --resolve 'bob.com:{0}:127.0.0.1' https://bob.com:{0}/case13".format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 35
