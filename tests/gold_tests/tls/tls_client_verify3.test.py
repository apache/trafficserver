...
tr.CurlCommand(
    "-v -k --tls-max 1.2  --cert {1}.pem --key {1}.key --resolve 'aaa.com:{0}:127.0.0.1'" +
    " https://aaa.com:{0}/xyz".format(ts.Variables.ssl_port, Test.TestDirectory + "/ssl/aaa-signed"))
...
tr.CurlCommand(
    ...
    " https://ccc.com:{0}/xyz".format(ts.Variables.ssl_port, Test.TestDirectory + "/ssl/ccc-signed"))
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Streams.All = Testers.ExcludesExpression("error", "Check response")
...
tr.CurlCommand(
    "-v -k --tls-max 1.2  --cert {1}.pem --key {1}.key --resolve 'aaa.com:{0}:127.0.0.1'" +
    " https://aaa.com:{0}/xyz".format(ts.Variables.ssl_port, Test.TestDirectory + "/ssl/bbb-signed"))
...
tr.StillRunningAfter = server
tr.CurlCommand(
    "-v -k --tls-max 1.2  --cert {1}.pem --key {1}.key --resolve 'bbb.com:{0}:127.0.0.1'" +
    " https://bbb.com:{0}/xyz".format(ts.Variables.ssl_port, Test.TestDirectory + "/ssl/ccc-signed"))
tr.Processes.Default.ReturnCode = 35
...
tr.CurlCommand(
    " -v -k --tls-max 1.2  --cert {1}.pem --key {1}.key --resolve 'ccc.com:{0}:127.0.0.1'" +
    " https://ccc.com:{0}/xyz".format(ts.Variables.ssl_port, Test.TestDirectory + "/ssl/aaa-signed"))
tr.Processes.Default.ReturnCode = 35
