...
remap:
  - type: map
    ...
    to:
      url: http://origin.example.com:{server.Variables.Port}/error
  - type: map_with_recv_port
    from:
      url: http://test.example.com:{ts.Variables.port}/
    to:
      url: http://origin.example.com:{server.Variables.Port}/ip
  - type: map_with_recv_port
    from:
