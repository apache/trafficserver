...
tr.MakeCurlCommand('--verbose --http1.1 --proxy localhost:{} http://www.example.com'.format(ts.Variables.port))
...
# HTTP 1.0
tr = Test.AddTestRun()
tr.MakeCurlCommand('--verbose --http1.0 --proxy localhost:{} http://www.example.com'.format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
# IPv6
tr = Test.AddTestRun()
tr.MakeCurlCommand('--verbose --http1.1 --proxy localhost:{} http://www.example.com'.format(ts.Variables.portv6))
tr.Processes.Default.ReturnCode = 0
tr.StillRunningAfter = server
tr.StillRunningAfter = ts
