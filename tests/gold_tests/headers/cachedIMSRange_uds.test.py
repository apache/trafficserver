...
tr.MakeCurlCommand(
    '-s -D - -v --http1.1 -H"UID: Fill" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/'
...
tr.DelayStart = 2
tr.MakeCurlCommand(
    '-s -D - -v --http1.1 -H"UID: IMS" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
tr.DelayStart = 2
tr.MakeCurlCommand(
    '--range 0-1 -s -D - -v --http1.1 -H"UID: IMS" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.MakeCurlCommand(
    '-s -D - -v --http1.1 -H"UID: EtagFill" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/etag'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
tr.StillRunningAfter = ts
tr.StillRunningAfter = server
...
tr.DelayStart = 2
tr.MakeCurlCommand(
    '-s -D - -v --http1.1 -H"UID: INM" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/etag'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
tr.DelayStart = 2
tr.MakeCurlCommand(
    '--range 0-1 -s -D - -v --http1.1 -H"UID: INM" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/etag'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
tr.DelayStart = 3
tr.MakeCurlCommand(
    '-s -D - -v --http1.1 -H"UID: noBody" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
tr.DelayStart = 2
tr.MakeCurlCommand(
    '-s -D - -v --http1.1 -H"UID: EtagError" -H "x-debug: x-cache,x-cache-key,via" -H "Host: www.example.com" http://localhost:{0}/etag'
    .format(ts.Variables.port))
tr.Processes.Default.ReturnCode = 0
