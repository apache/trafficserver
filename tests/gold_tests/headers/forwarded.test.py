...
#
tr.CurlCommand('--verbose --ipv4 --http1.1 --proxy localhost:{} http://www.no-oride.com'.format(ts.Variables.port))
...
def TestHttp1_1(host):
    ...
    tr = Test.AddTestRun()
    tr.CurlCommand('--verbose --ipv4 --http1.1 --proxy localhost:{} http://{}'.format(ts.Variables.port, host))
    tr.Processes.Default.ReturnCode = 0
...
#
tr.CurlCommand('--verbose --ipv4 --http1.1 --proxy localhost:{} http://www.no-oride.com'.format(ts2.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
# HTTP 1.0
tr = Test.AddTestRun()
tr.CurlCommand('--verbose --ipv4 --http1.0 --proxy localhost:{} http://www.no-oride.com'.format(ts2.Variables.port))
tr.Processes.Default.ReturnCode = 0
...
tr = Test.AddTestRun()
tr.CurlCommand('--verbose --ipv6 --http1.1 --proxy localhost:{} http://www.no-oride.com'.format(ts2.Variables.portv6))
tr.Processes.Default.ReturnCode = 0
