...
tr.CurlCommand(f'-vs -k --http2 https://127.0.0.1:{ts.Variables.ssl_port}/huge_resp_hdrs |& grep -v "bytes data"')
tr.Processes.Default.ReturnCode = 0
...
tr.CurlCommand('-vs -k --http2 https://127.0.0.1:{0}/status/204'.format(ts.Variables.ssl_port))
tr.Processes.Default.ReturnCode = 0
