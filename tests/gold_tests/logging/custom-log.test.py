...
# need Curl
Test.SkipUnless(
    Condition.HasProgram("curl", "Curl need to be installed on system for this test to work"), Condition.IsPlatform("linux"))
...
ts.Disk.logging_config.AddLines('''custom = format {
  Format = "%<hii> %<hiih>"
}
