...
tr.MakeCurlCommand(
    '--verbose --ipv4 --header "Host: test-1" --header "X-Primary-Id: primary-1" --header "X-Secondary-Id: secondary-1" --header "X-Remote-Ip: 203.0.113.10" http://127.0.0.1:{0}/test-1'.format(
        ts.Variables.port
    ),
    ts=ts,
)
