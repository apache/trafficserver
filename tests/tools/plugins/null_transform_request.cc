...
transform_plugin(TSCont /* contp ATS_UNUSED */, TSEvent event, void *edata)
{
  ...
  case TS_EVENT_HTTP_READ_REQUEST_HDR:
    Dbg(plugin_ctl, "\tEvent is TS_EVENT_HTTP_READ_REQUEST_HDR");
    transform_add(txnp);
...
TSPluginInit(int /* argc ATS_UNUSED */, const char ** /* argv ATS_UNUSED */)
{
  ...
  stat_ua_bytes_sent =
    TSStatCreate("null_transform_request.ua.bytes_sent", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_SUM);
  stat_os_bytes_sent =
    TSStatCreate("null_transform_request.os.bytes_sent", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_SUM);
  stat_error = TSStatCreate("null_transform_request.error", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_SUM);
  stat_test_done =
    TSStatCreate("null_transform_request.test.done", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_SUM);
