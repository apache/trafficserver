...
class ProxyHTTPSConnection(http.client.HTTPSConnection):
    ...
    def connect(self):
        ...
        self.sock = self._context.wrap_socket(
            self.sock, do_handshake_on_connect=True, server_side=False, server_hostname=server_hostname)
    ...
    try:
        ...
        if method == 'GET':
            request_session.request(
                'GET',
                'https://' + extractHeader.extract_host(txn_req_headers) + extractHeader.extract_GET_path(txn_req_headers),
