...
def test_crashlog_no_false_positive(urtest: UraniumTest) -> None:
    '''
    ...
    tr = urtest.AddTestRun('Start traffic_server with the crash log helper armed, then let AuTest SIGTERM it')
