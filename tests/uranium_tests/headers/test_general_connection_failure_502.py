...
def test_general_connection_failure_502(urtest: UraniumTest) -> None:
    '''
    ...
    server = urtest.MakeOriginServer("server", ssl=False)  # Reserves a port across autest.
    ...
    data_file = urtest.Disk.File("www.connectfail502.test-get.txt", id="datafile")
