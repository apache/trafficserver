...
def test_cache_shm_control_size_mismatch(urtest: UraniumTest) -> None:
    '''
    ...
    class CacheShmControlSizeMismatchTest:
        ...
        def _add_diags_log_assertions(self):
            ...
            self.ts3.Disk.diags_log.Content += Testers.ContainsExpression(
                ...
                'ts3 should reuse the per-stripe directory from shm')
        ...
        def _grow_control_segment(self):
            ...
            tr = urtest.AddTestRun('Grow the shm control segment past this build\'s size')
            tr.Processes.Default.Command = (
