...
def test_cache_shm_concurrent_attach(urtest: UraniumTest) -> None:
    '''
    ...
    class CacheShmConcurrentAttachTest:
        ...
        def _start_owner(self):
            tr = urtest.AddTestRun('Cold-start ts1 (becomes the shm owner)')
        ...
        def _start_second_refused(self):
            ...
            tr = urtest.AddTestRun('Start ts2 while ts1 is live; ts2 must refuse shm and serve from disk')
