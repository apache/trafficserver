...
def test_cache_corrupt_recursive_uaf(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'Recursive cache read must not use-after-free when every doc magic is corrupt'
    ...
    urtest.SkipUnless(Condition.HasATSFeature('TS_HAS_TESTS'))
    ...
    ts.Disk.diags_log.Content = Testers.ContainsExpression(
        "Doc magic does not match", "the forced-corrupt earliest-read path must run")
