...
def test_cache_shm_bad_disk_dropped(urtest: UraniumTest) -> None:
    '''
    ...
    class CacheShmBadDiskDroppedTest:
        ...
        def _populate_cache(self):
            tr = urtest.AddTestRun('Populate cache via ts1 (disk_a + disk_b)')
        ...
        def _clean_shutdown_ts1(self):
            tr = urtest.AddTestRun('Drain and clean-shutdown ts1')
        ...
        def _dump_shm_state(self):
            ...
            tr = urtest.AddTestRun('Dump shm control state after ts1 clean shutdown')
        ...
        def _verify_survivor_attach_and_reclaim(self):
            tr = urtest.AddTestRun('Start ts2 (disk_b dropped); verify survivor fast-attach + orphan reclaim')
        ...
        def _clean_shutdown_ts2(self):
            ...
            tr = urtest.AddTestRun('Drain and clean-shutdown ts2')
