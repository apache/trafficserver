...
def test_host_down_range_recursion(urtest: UraniumTest) -> None:
    '''
    ...
    class HostDownRangeRecursionTest:
        ...
        def __init__(self):
            ...
            self._server = urtest.MakeVerifierServerProcess("server", self.prime_replay)
            self._configure_ts()
        ...
        def _configure_ts(self):
            ...
            self._ts.Disk.remap_config.AddLine(
                f'map http://backend.example.com/ http://127.0.0.1:{self._server.Variables.http_port}/')

        def run(self):
            # Phase 1: prime the cache with the full object.
            prime = urtest.AddTestRun("Prime cache with full object")
            ...
            mark_down = urtest.AddTestRun("Mark host DOWN")
            ...
            range_run = urtest.AddTestRun("Out-of-order Range against DOWN host")
