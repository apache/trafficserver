...
def test_cache_shm_schema_mismatch(urtest: UraniumTest) -> None:
    '''
    ...
    class CacheShmSchemaMismatchTest:
        ...
        def _poke_schema_version(self):
            ...
            tr = urtest.AddTestRun('Tamper schema_version in the shm control segment')
            tr.Processes.Default.Command = (
        ...
        def _verify_mismatch_drop(self):
            tr = urtest.AddTestRun('Start ts2; verify the schema mismatch is dropped and rebuilt from disk')
