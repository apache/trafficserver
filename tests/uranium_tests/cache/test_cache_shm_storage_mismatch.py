...
def test_cache_shm_storage_mismatch(urtest: UraniumTest) -> None:
    '''
    ...
    class CacheShmStorageMismatchTest:
        ...
        def _populate_cache(self):
            tr = urtest.AddTestRun('Populate cache via ts1 (storage A)')
        ...
        def _verify_partial_attach_and_reclaim(self):
            tr = urtest.AddTestRun('Start ts2 (storage B); verify partial attach: fresh stripe + orphan reclaim')
