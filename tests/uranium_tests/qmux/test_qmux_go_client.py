...
def test_qmux_go_client(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = '''Verify that a Go QMux client can complete HTTP/3 transactions through ATS.'''
    ...
    class TestQMuxGoClient:
        ...
        def __init__(self) -> None:
            ...
            tr = urtest.AddTestRun('Go HTTP/3 over QMux client request')
    ...
    '''.split('\n'))
            ...
            access_log = urtest.Disk.File(os.path.join(ts.Variables.LOGDIR, 'qmux_access.log'), exists=True)
