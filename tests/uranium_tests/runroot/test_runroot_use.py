...
def test_runroot_use(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    path = os.path.join(urtest.RunDirectory, "runroot")
    ...
    tr = urtest.AddTestRun("use runroot via commandline")
    ...
    tr = urtest.AddTestRun("use runroot via cwd")
    ...
    tr = urtest.AddTestRun("use runroot via bin executable")
    ...
    tr = urtest.AddTestRun("use runroot via TS_RUNROOT")
