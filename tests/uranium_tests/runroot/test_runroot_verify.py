...
def test_runroot_verify(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    prefix = urtest.Variables["PREFIX"]
    bindir = urtest.Variables["BINDIR"]
    logdir = urtest.Variables["LOGDIR"]
    ...
    tr = urtest.AddTestRun("verify runroot test2")
