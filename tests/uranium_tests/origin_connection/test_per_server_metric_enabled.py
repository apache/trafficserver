...
def test_per_server_metric_enabled(urtest: UraniumTest) -> None:
    '''
    ...
    class PerServerMetricEnabledTest:
        ...
        def _configure_server(self) -> None:
            ...
            self._server = urtest.MakeVerifierServerProcess('metric_enabled_server', self._replay_file)

        def _configure_trafficserver(self) -> None:
            """Configure Traffic Server to be used in the test."""
            self._ts = urtest.MakeATSProcess("ts_metric_enabled")
        ...
        def _test_connection_is_reaped(self) -> None:
            ...
            tr = urtest.AddTestRun("Verify the idle keep-alive origin connection is reaped")
        ...
        def _test_tracker_info(self) -> None:
            ...
            tr = urtest.AddTestRun("Verify the connection tracker report")
        ...
        def run(self) -> None:
            ...
            tr = urtest.AddTestRun('Perform a transaction that leaves a pooled origin connection')
