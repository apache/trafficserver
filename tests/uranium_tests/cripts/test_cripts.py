...
def test_cripts(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.testName = "cripts: basic functions"
    urtest.Summary = '''
    ...
    class CriptsBasicTest:
        ...
        def setUpTS(self):
            self.ts = urtest.MakeATSProcess("ts_in", enable_tls=True, enable_cache=False, enable_cripts=True)
    ...
    """.split("\n"))
        ...
        def runHeaderTest(self):
            tr = urtest.AddTestRun('Exercise traffic through cripts.')
        ...
        def runCertsTest(self):
            tr = urtest.AddTestRun('Exercise Cripts certificate introspection.')
            tr.MakeCurlCommand(
        ...
        def runQueryCopyTest(self):
            tr = urtest.AddTestRun('Exercise Query/Path copy ctor / copy-assign in cripts.')
            tr.MakeCurlCommand(
