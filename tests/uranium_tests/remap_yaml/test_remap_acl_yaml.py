...
def test_remap_acl_yaml(urtest: UraniumTest) -> None:
    '''
    ...
    class Test_remap_acl:
        ...
        def __init__(
                ...
                acl_configuration: List[str], named_acls: List[Tuple[str, List[str]]], expected_responses: List[int],
                proxy_protocol: bool):
            """Initialize the test.
        ...
        def _configure_traffic_server(self) -> int:
            ...
            if Test_remap_acl._ts is not None:
                ...
                ts = urtest.MakeATSProcess("ts", enable_cache=False, enable_proxy_protocol=True, enable_uds=False)
            ...
            if call_reload:
                ...
                #
                tr = urtest.AddTestRun("Change the ATS configuration")
                ...
                urtest.AddConfigReload(ts, expect_tasks=["remap.yaml"], description="Reload the ATS configuration")
