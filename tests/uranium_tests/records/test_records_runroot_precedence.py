...
def test_records_runroot_precedence(urtest: UraniumTest) -> None:
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    #  distributed with this work for additional information
    #  regarding copyright ownership.  The ASF licenses this file
    ...
    ts_dir = os.path.join(urtest.RunDirectory, "ts")
    ...
    tr = urtest.AddTestRun("Create runroot.yaml")
    ...
    # ---------------------------------------------------------------------------
    tr = urtest.AddTestRun("Start ATS with runroot")
    ...
    # ---------------------------------------------------------------------------
    tr = urtest.AddTestRun("Verify runroot overrides records.yaml for path records")
    ...
    # ---------------------------------------------------------------------------
    tr = urtest.AddTestRun("Verify env var overrides both runroot and records.yaml")
