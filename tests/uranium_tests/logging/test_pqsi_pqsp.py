...
def test_pqsi_pqsp(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    tr.MakeCurlCommand(f'--verbose http://localhost:{ts.Variables.port}/test', ts=ts)
    ...
    # deterministic.
    urtest.AddAwaitFileContainsTestRun('Await pqsi/pqsp cache-miss line.', log_filespec, r'^127\.0\.0\.1 [1-6][0-9]*$')
    urtest.AddAwaitFileContainsTestRun('Await pqsi/pqsp cache-hit line.', log_filespec, r'^0 0$')
