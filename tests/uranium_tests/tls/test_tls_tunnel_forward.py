...
def test_tls_tunnel_forward(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    server_bar = urtest.MakeOriginServer("server_bar", ssl=False)
    server_random = urtest.MakeOriginServer("server_random", ssl=False)
    ...
    tr = urtest.AddTestRun("Tunnel-test")
    ...
    tr2 = urtest.AddTestRun("Forward-test")
    tr2.MakeCurlCommand(
    ...
    tr3 = urtest.AddTestRun("no-sni-forward-test")
    ...
    tr.Processes.Default.Command = (
        ...
        f" {urtest.TestDirectory}/gold/tls-tunnel-forward-metrics.gold")
