...
def test_tls_client_cert2_plugin(urtest: UraniumTest) -> None:
    '''
    ...
    # Should succeed
    tr = urtest.AddTestRun("bob.bar.com to server 1")
    tr.Processes.Default.StartBefore(urtest.Processes.ts, ready=When.PortOpen(ts.Variables.port))
    ...
    # Should fail
    trfail = urtest.AddTestRun("bob.bar.com to server 2")
    ...
    # Should succeed
    tr = urtest.AddTestRun("bob.foo.com to server 1")
    tr.StillRunningAfter = ts
    tr.StillRunningAfter = server
    tr.StillRunningAfter = server2
    ...
    # Should fail
    trfail = urtest.AddTestRun("bob.foo.com to server 2")
    trfail.StillRunningAfter = ts
    trfail.StillRunningAfter = server
    trfail.StillRunningAfter = server2
    ...
    # Should succeed
    tr = urtest.AddTestRun("random.bar.com to server 2")
    tr.StillRunningAfter = ts
    tr.StillRunningAfter = server
    tr.StillRunningAfter = server2
    ...
    # Should fail
    trfail = urtest.AddTestRun("random.bar.com to server 1")
    trfail.StillRunningAfter = ts
    trfail.StillRunningAfter = server
    trfail.StillRunningAfter = server2
    ...
    # Should fail
    tr = urtest.AddTestRun("random.foo.com to server 2")
    tr.StillRunningAfter = ts
    tr.StillRunningAfter = server
    tr.StillRunningAfter = server2
    ...
    # Should fail
    trfail = urtest.AddTestRun("random.foo.com to server 1")
    trfail.StillRunningAfter = ts
    trfail.StillRunningAfter = server
    trfail.StillRunningAfter = server2
