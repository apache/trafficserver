...
def test_tls_verify_override_base(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    # Should fail
    tr = urtest.AddTestRun("foo-to-bar-sni-policy-servername")
    tr.MakeCurlCommand(
    ...
    # Should succeed
    tr = urtest.AddTestRun("bar-to-foo-sni-policy-servername")
    tr.MakeCurlCommand(
