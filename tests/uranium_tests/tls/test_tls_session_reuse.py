...
def test_tls_session_reuse(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    tr1 = urtest.AddTestRun("TLSv1.2 Session Resumption Enabled")
    tr1.Command = \
        ...
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2' \
        .format(ts1.Variables.ssl_port, os.path.join(urtest.RunDirectory, 'sess1.dat'))
    tr1.ReturnCode = 0
    ...
    tr2 = urtest.AddTestRun("TLSv1.3 Session Resumption Enabled")
    tr2.Command = \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_out {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        ...
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2' \
        .format(ts1.Variables.ssl_port, os.path.join(urtest.RunDirectory, 'sess2.dat'))
    tr2.ReturnCode = 0
    ...
    tr3 = urtest.AddTestRun("TLSv1.2 Session Resumption Disabled")
    tr3.Command = \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_out {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        ...
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_2' \
        .format(ts2.Variables.ssl_port, os.path.join(urtest.RunDirectory, 'sess3.dat'))
    ...
    tr4 = urtest.AddTestRun("TLSv1.3 Session Resumption Disabled")
    tr4.Command = \
        ...
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_3 && ' \
        'printf "GET / HTTP/1.1\r\n" | openssl s_client -connect 127.0.0.1:{0} -sess_in  {1} -tls1_3' \
        .format(ts2.Variables.ssl_port, os.path.join(urtest.RunDirectory, 'sess4.dat'))
