...
def test_tls_client_cert_plugin(ats_factory: ATSFactory, services: ServiceFactory, curl: Curl) -> None:
    """The secret-loader plugin resolves and reloads outbound client certificate paths."""
