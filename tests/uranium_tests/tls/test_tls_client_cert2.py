...
def test_tls_client_cert2(ats_factory: ATSFactory, services: ServiceFactory, curl: Curl) -> None:
    """Exact and wildcard SNI names select the expected outbound client certificate."""
