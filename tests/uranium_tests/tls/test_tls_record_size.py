...
def test_tls_record_size(urtest: UraniumTest) -> None:
    '''
    ...
    class TestRecordSize:
        ...
        def _configure_server(self) -> 'Process':
            ...
            '''
            server = urtest.MakeOriginServer(f'server-{TestRecordSize._server_counter}')
        ...
        def _configure_trafficserver(self) -> 'Process':
            ...
            '''
            ts = urtest.MakeATSProcess(f'ts-{TestRecordSize._ts_counter}', enable_tls=True)
    ...
    """.split("\n"))
        ...
        def run(self) -> None:
            ...
            tr.Processes.Default.Command = (
                f'{sys.executable} {os.path.join(urtest.TestDirectory, "tls_record_size_client.py")} '
