...
def test_null_transform(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.SkipUnless(Condition.PluginExists('null_transform.so'))
    ...
    # Load plugin
    urtest.PrepareInstalledPlugin('null_transform.so', ts)
