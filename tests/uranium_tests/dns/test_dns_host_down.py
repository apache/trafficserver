...
def test_dns_host_down(urtest: UraniumTest) -> None:
    '''
    ...
    class DownCachedOriginServerTest:
        ...
        def __init__(self):
            ...
            self._server = urtest.MakeVerifierServerProcess("server", DownCachedOriginServerTest.replay_file)
            ...
            self._ts.Disk.records_config.update(
                {
                    ...
                    'proxy.config.hostdb.host_file.path': os.path.join(urtest.TestDirectory, "hosts_file"),
                })
        ...
        def _test_down_server_no_requests_metric(self):
            tr = urtest.AddTestRun('Check proxy.process.http.down_server.no_requests metric')
