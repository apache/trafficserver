...
def test_chunk_extension_quoted_string(urtest: UraniumTest) -> None:
    '''
    ...
    class ChunkExtensionQuotedStringTest:
        ...
        def _setup_origin(self):
            ...
            self._server = urtest.MakeVerifierServerProcess("verifier-server", "replays/chunk_extension_quoted_string.replay.yaml")
        ...
        def _check(self, tr):
            ...
            tr.Processes.Default.Streams.stdout += Testers.ContainsExpression(
                "responses=1", "the client must get exactly one response")
        ...
        def run(self):
            ...
            tr = urtest.AddTestRun("Quoted extension value containing CRLF")
            ...
            tr = urtest.AddTestRun("Quoted extension split across reads")
            tr.Setup.Copy("chunk_extension_client.py")
