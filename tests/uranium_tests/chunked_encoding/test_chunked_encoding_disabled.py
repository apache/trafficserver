...
def test_chunked_encoding_disabled(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'Test ATS configured to not respond with chunked content.'
    ...
    class ChunkedEncodingDisabled:
        ...
        def setupOriginServer(self):
            self.server = urtest.MakeVerifierServerProcess("server", self.chunkedReplayFile)

        def setupTS(self):
            self.ts = urtest.MakeATSProcess("ts", enable_tls=True, enable_cache=False)
