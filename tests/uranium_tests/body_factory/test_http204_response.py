...
def test_http204_response(urtest: UraniumTest) -> None:
    '''
    ...
    defaultTr = urtest.AddTestRun("Test domain {0}".format(DEFAULT_204_HOST))
    defaultTr.Processes.Default.StartBefore(urtest.Processes.ts)
    ...
    customTemplateTr = urtest.AddTestRun(f"Test domain {CUSTOM_TEMPLATE_204_HOST}")
