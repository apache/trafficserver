...
def test_http_with_origin(urtest: UraniumTest) -> None:
    '''
    ...
    trhead200 = urtest.AddTestRun("Test domain {0}".format(HOST))
    trhead200.Processes.Default.StartBefore(urtest.Processes.ts)
    ...
    trget200 = urtest.AddTestRun("Test domain {0}".format(HOST))
    ...
    trget304 = urtest.AddTestRun("Test domain {0}".format(HOST))
