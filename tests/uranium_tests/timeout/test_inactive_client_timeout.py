...
def test_inactive_client_timeout(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.Summary = 'Testing ATS client inactivity timeout'
    ...
    tr = urtest.AddTestRun("Verify that server delay does not trigger client activity timeout.")
