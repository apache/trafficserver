...
def test_accept_timeout(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.Summary = 'Testing ATS inactivity timeout'
    ...
    tr.Processes.Default.Streams.stdout = Testers.ContainsExpression(
        "Accept timeout", "Request should fail from the accept timeout")

    # case 2 TLS with incomplete request header
    tr2 = urtest.AddTestRun("tr")
