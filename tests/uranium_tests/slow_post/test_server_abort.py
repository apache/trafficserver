...
def test_server_abort(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    ts.Disk.records_config.update(
        {
            ...
            'proxy.config.ssl.server.cert.path': f'{urtest.TestDirectory}/test_secrets',
            'proxy.config.ssl.server.private_key.path': f'{urtest.TestDirectory}/test_secrets',
        })
