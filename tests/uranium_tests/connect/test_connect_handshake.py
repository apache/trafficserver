...
def test_connect_handshake(urtest: UraniumTest) -> None:
    ...
    urtest.Summary = 'Verify CONNECT waits for the origin TCP handshake.'
    ...
    class ConnectHandshakeTest:
        ...
        def __init__(self) -> None:
            ...
            tr = urtest.AddTestRun('CONNECT to a refused origin port')
