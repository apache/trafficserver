...
def test_pipeline(urtest: UraniumTest) -> None:
    ...
    urtest.Summary = '''Test pipelined requests and HTTP/1.1 request framing.'''
    ...
    class TestPipelining:
        ...
        def __init__(self, buffer_requests: bool) -> None:
            ...
            """
            tr = urtest.AddTestRun('Test a pipelined chunked encoded request.')
            tr.TimeOut = 10
        ...
        def _configure_client(self, tr: 'TestRun') -> 'Process':
            ...
            client.Streams.All += Testers.ContainsExpression(
                '403', 'Should receive the ATS-generated rejection of the DELETE request.')
    ...
    class TestRequestFraming:
        ...
        def _configure_client(self, tr: 'TestRun') -> 'Process':
            ...
            if self._mode == 'pipeline':
                ...
                client.Streams.All += Testers.ContainsExpression(
                    r'STATUS_LINE_COUNT: 1', 'Client should receive exactly one response.')
