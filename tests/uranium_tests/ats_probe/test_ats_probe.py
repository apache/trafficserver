...
def test_ats_probe(urtest: UraniumTest) -> None:
    ...
    urtest.Summary = '''Verify SystemTap ATS probes.'''
    ...
    urtest.SkipUnless(Condition(lambda: False, "Test requires privilege", True))
    urtest.SkipUnless(Condition.HasProgram("bpftrace", "Need bpftrace to verify the probe."))
    ...
    class TestATSProbe:
        ...
        def __init__(self):
            ...
            tr = urtest.AddTestRun('Verify ATS probes.')
