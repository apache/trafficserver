...
def test_http2_crlf_header_validation(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'HTTP/2 requests with NUL, CR, or LF in header values are rejected'
    ...
    urtest.Setup.CopyAs('../connect/' + MALFORMED_CLIENT, urtest.RunDirectory)
