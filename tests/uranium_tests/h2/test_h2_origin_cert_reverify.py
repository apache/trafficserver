...
def test_h2_origin_cert_reverify(urtest: UraniumTest) -> None:
    '''
    ...
    tr = urtest.AddTestRun("Prime an H2 origin connection for foo.com")
    ...
    tr = urtest.AddTestRun("Reject reuse for bar.com")
