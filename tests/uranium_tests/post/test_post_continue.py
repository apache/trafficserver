...
def test_post_continue(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    ts2 = urtest.MakeATSProcess("ts2", enable_tls=True, enable_cache=False)
    ...
    test_run = urtest.AddTestRun("http1.1 POST small body with Expect header")
    ...
    test_run = urtest.AddTestRun("http1.1 POST large body with Expect header")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http1.1 -H "uuid: post" -H "Expect: 100-continue" -d @big_post_body -k https://127.0.0.1:{0}/post'
    ...
    test_run = urtest.AddTestRun("http1.1 POST small body w/o Expect header")
    test_run.MakeCurlCommand(
    ...
    test_run = urtest.AddTestRun("http1.1 POST large body w/o Expect header")
    test_run.MakeCurlCommand(
    ...
    test_run = urtest.AddTestRun("http2 POST small body with Expect header")
    test_run.MakeCurlCommand(
    ...
    test_run = urtest.AddTestRun("http2 POST large body with Expect header")
    test_run.MakeCurlCommand(
    ...
    test_run = urtest.AddTestRun("http2 POST small body w/o Expect header")
    test_run.MakeCurlCommand(
    ...
    test_run = urtest.AddTestRun("http2 POST large body w/o Expect header")
    test_run.MakeCurlCommand(
    ...
    test_run = urtest.AddTestRun("http1.1 POST small body with Expect header, immediate")
    test_run.Processes.Default.StartBefore(urtest.Processes.ts2)
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http1.1 -H "uuid: post" -H "Expect: 100-continue" -d "small body" -k https://127.0.0.1:{0}/post'.format(
    ...
    test_run = urtest.AddTestRun("http1.1 POST large body with Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http1.1 -H "uuid: post" -H "Expect: 100-continue" -d @big_post_body -k https://127.0.0.1:{0}/post'
    ...
    test_run = urtest.AddTestRun("http1.1 POST small body w/o Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http1.1 -H "uuid: post" -H "Expect:" -d "small body" -k https://127.0.0.1:{0}/post'.format(
            ts2.Variables.ssl_port),
        ts=ts2)
    ...
    test_run = urtest.AddTestRun("http1.1 POST large body w/o Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http1.1 -H "uuid: post" -H "Expect: " -d @big_post_body -k https://127.0.0.1:{0}/post'.format(
            ts2.Variables.ssl_port),
        ts=ts2)
    ...
    test_run = urtest.AddTestRun("http2 POST small body with Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http2 -H "uuid: post" -H "Expect: 100-continue" -d "small body" -k https://127.0.0.1:{0}/post'.format(
            ts2.Variables.ssl_port),
        ts=ts2)
    ...
    test_run = urtest.AddTestRun("http2 POST large body with Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http2 -H "uuid: post" -H "Expect: 100-continue" -d @big_post_body -k https://127.0.0.1:{0}/post'.format(
            ts2.Variables.ssl_port),
        ts=ts2)
    ...
    test_run = urtest.AddTestRun("http2 POST small body w/o Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http2 -H "uuid: post" -H "Expect: " -d "small body" -k https://127.0.0.1:{0}/post'.format(
            ts2.Variables.ssl_port),
        ts=ts2)
    ...
    test_run = urtest.AddTestRun("http2 POST large body w/o Expect header, immediate")
    test_run.MakeCurlCommand(
        '-v -o /dev/null --http2 -H "uuid: post" -H "Expect: " -d @big_post_body -k https://127.0.0.1:{0}/post'.format(
            ts2.Variables.ssl_port),
        ts=ts2)
