...
def test_h3_python_client(urtest: UraniumTest) -> None:
    '''
    ...
    class TestHttp3PythonClient:
        ...
        def _configure_traffic_server(self):
            ...
            ts = urtest.MakeATSProcess("ts-python-h3-client", enable_tls=True, enable_quic=True, enable_cache=False)
    ...
    '''.split("\n"))
            ...
            self._access_log = urtest.Disk.File(os.path.join(ts.Variables.LOGDIR, 'h3_python_access.log'), exists=True)
        ...
        def _configure_client(self):
            ...
            tr = urtest.AddTestRun("Wait for aioquic HTTP/3 access log")
            tr.Processes.Default.Command = (
