...
def test_per_client_connection_max(urtest: UraniumTest) -> None:
    '''
    ...
    class PerClientConnectionMaxTest:
        ...
        def __init__(
                self, protocol: int, exempt_list: str = '', exempt_list_file: str = '', exempt_list_applies: bool = False) -> None:
        ...
        def _configure_server(self, tr: 'TestRun') -> None:
            ...
            if self._exempt_list_applies:
                ...
                self._server.Streams.All += Testers.ExcludesExpression(
                    "fourth-request", "Verify the fourth request was not received.")
    ...
    """.split("\n"))
        ...
        def _verify_metrics(self) -> None:
            ...
            tr = urtest.AddTestRun("Verify the per client connection metrics.")
