...
def test_strategies_plugins(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    for char in chars:
        name = f"nh{char}"
        origin = urtest.MakeOriginServer(name, options={"--verbose": ""})
        request_header = {
    ...
    tr = urtest.AddTestRun("nhp_hr parent.config through request")
    ...
    tr = urtest.AddTestRun("nhs_hr straight through request")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh0_hr straight through request")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh1_hr straight through request")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh2_hr straight through request")
    ps = tr.Processes.Default
    ...
    # 5 switch strategies
    tr = urtest.AddTestRun("nh0_hr switch to nh1")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh1_hr switch to parent.config")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh2_hr switch to nh0")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh0_hr switch to nemo (fail)")
    ps = tr.Processes.Default
    ...
    # 9 use parent.config
    tr = urtest.AddTestRun("nhp_rr parent.config")
    ps = tr.Processes.Default
    ...
    # 10 use strategies
    tr = urtest.AddTestRun("nhs_rr strategies.yaml")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh0_rr switch to nh1")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh1_rr switch to parent.config")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh2_rr switch to nh0")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh0_rr switch to nemo")
    ps = tr.Processes.Default
    ...
    # 15 parent.config
    tr = urtest.AddTestRun("nhp_lua parent.config")
    ps = tr.Processes.Default
    ...
    # 16 strategies.yaml
    tr = urtest.AddTestRun("nhs_lua strategies.yaml")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh0_lua switch to nh1")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh1_lua switch to parent.config")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh2_lua switch to nh0")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("nh0_lua switch to nemo")
    ps = tr.Processes.Default
