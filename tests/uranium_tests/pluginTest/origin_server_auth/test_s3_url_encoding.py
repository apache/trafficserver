...
def test_s3_url_encoding(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.testName = "origin_server_auth: URL encoding bug"
    urtest.Summary = '''
    ...
    class S3UrlEncodingTest:
        ...
        def setupOriginServer(self):
            ...
            """
            self.server = urtest.MakeOriginServer("s3_mock")
        ...
        def setupTS(self):
            ...
            self.ts.Setup.CopyAs('rules/s3_url_encoding.test_input', urtest.RunDirectory)
            ...
            self.ts.Disk.remap_config.AddLine(
                ...
                f'@pparam=--config @pparam={urtest.RunDirectory}/s3_url_encoding.test_input')
        ...
        def test_unencoded_parentheses(self):
            ...
            """
            tr = urtest.AddTestRun("Unencoded parentheses in path")
        ...
        def test_encoded_parentheses(self):
            ...
            """
            tr = urtest.AddTestRun("Encoded parentheses in path")
            tr.Processes.Default.Command = (
                f'curl -s -v -o /dev/null '
                f'-H "Host: s3.amazonaws.com" '
        ...
        def test_mixed_encoding_bug(self):
            ...
            """
            tr = urtest.AddTestRun("Mixed encoding - BUG CASE")
            tr.Processes.Default.Command = (
                f'curl -s -v -o /dev/null '
                f'-H "Host: s3.amazonaws.com" '
