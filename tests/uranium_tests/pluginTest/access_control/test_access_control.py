...
def test_access_control(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.SkipUnless(Condition.PluginExists('access_control.so'))
    ...
    class AccessControlTest:
        ...
        def setupTS(self):
            self.ts = urtest.MakeATSProcess("ts", enable_tls=True)
    ...
    """.split("\n"))
        ...
        @pparam=--symmetric-keys-map={urtest.RunDirectory}/hmac_keys.txt \
        ...
        def run(self):
            tr = urtest.AddTestRun("Session Cookie")
