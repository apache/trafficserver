...
def test_compress_content_type_params(urtest: UraniumTest) -> None:
    '''
        ...
        def setupTS(self):
            ...
            self.ts.Disk.remap_config.AddLines(
                [
                    ...
                    f' @pparam={urtest.RunDirectory}/ignore-params-false.config',
                    f'map /ignore-params-true/ http://127.0.0.1:{self.server.Variables.http_port}/ @plugin=compress.so' +
                    f' @pparam={urtest.RunDirectory}/ignore-params-true.config',
                ])
