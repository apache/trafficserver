...
def test_rate_limit_sni_queue(urtest: UraniumTest) -> None:
    '''
    ...
    class RateLimitSniQueueTest:
        ...
        def __init__(self) -> None:
            tr = urtest.AddTestRun('rate_limit SNI queue accounting')
        ...
        def _configure_client(self, tr: 'TestRun') -> None:
            ts = self._ts
            client = os.path.join(urtest.TestDirectory, 'rate_limit_sni_queue_client.sh')
