...
def test_lua_set_error_response(urtest: UraniumTest) -> None:
    ...
    class TestLuaSetErrorResponse:
        ...
        def __init__(self):
            tr = urtest.AddTestRun("Lua ts.client_response.set_error_resp")
        ...
        def _configure_client(self, tr: 'TestRun') -> 'Process':
            ...
            client.Streams.All += Testers.ContainsExpression(
                'bad luck', 'The modified HTTP response body should contain "bad luck".')
            return client
