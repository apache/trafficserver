...
def test_lua_proxy_protocol(urtest: UraniumTest) -> None:
    '''
    ...
    # ---- Setup ATS ----
    ts = urtest.MakeATSProcess("ts", enable_proxy_protocol=True)
    ...
    tr = urtest.AddTestRun("Test with PROXY protocol v1")
