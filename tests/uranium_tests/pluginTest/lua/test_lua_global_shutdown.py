...
def test_lua_global_shutdown(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Setup.Copy("global_shutdown.lua")
    ...
    ts.Disk.plugin_config.AddLine('tslua.so --states=2 {}/global_shutdown.lua'.format(urtest.RunDirectory))
    ...
    tr = urtest.AddTestRun("Lua global read request hook fires for HTTP requests")
