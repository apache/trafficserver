...
def test_matchcookie(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.testName = "cookie_remap: match cookie"
    ...
    config_path = os.path.join(urtest.TestDirectory, "configs/matchconfig.txt")
    ...
    tr = urtest.AddTestRun("cookie value matches")
    tr.MakeCurlCommand(
        ''' --proxy 127.0.0.1:{0} \
