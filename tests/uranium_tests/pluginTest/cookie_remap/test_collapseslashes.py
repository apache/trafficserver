...
def test_collapseslashes(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.testName = "cookie_remap: plugin collapses consecutive slashes"
    ...
    config_path = os.path.join(urtest.TestDirectory, "configs/collapseconfig.txt")
