...
def test_psubstitute(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.testName = "cookie_remap: Substitute variables (pre-remap URL)"
    ...
    config_path = os.path.join(urtest.TestDirectory, "configs/psubstituteconfig.txt")
    ...
    tr = urtest.AddTestRun("Substitute $ppath in the dest query")
    tr.MakeCurlCommand(
        ''' --proxy 127.0.0.1:{0} \
    ...
    tr = urtest.AddTestRun("Substitute $unmatched_ppath in the dest query")
    tr.MakeCurlCommand(
        ''' --proxy 127.0.0.1:{0} \
    ...
    tr = urtest.AddTestRun("Substitute $cr_req_purl using $cr_urlencode")
    tr.MakeCurlCommand(
        ''' --proxy 127.0.0.1:{0} \
    "http://www.example.com/magic" \
    ...
    tr = urtest.AddTestRun("Substitute $ppath as is in outgoing path")
    tr.MakeCurlCommand(
        ''' --proxy 127.0.0.1:{0} \
