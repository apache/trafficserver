...
def test_txn_box_txn_debug(urtest: UraniumTest) -> None:
    # @file
    #
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.SkipIf(Condition.true("This needs to be revisit. TS not finishing up gracefully."))
    ...
    ts.Disk.traffic_out.Content += Testers.ContainsExpression(
        r"DIAG: <HttpSM.cc", "Verify that there was transaction level debugging.")
