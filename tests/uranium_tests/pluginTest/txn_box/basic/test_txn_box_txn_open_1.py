...
def test_txn_box_txn_open_1(urtest: UraniumTest) -> None:
    # @file
    #
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    tr = urtest.TxnBoxTestAndRun("Test txn_open 1", "txn_open_1.replay.yaml", config_path='Auto', config_key="meta.txn_box.global")
