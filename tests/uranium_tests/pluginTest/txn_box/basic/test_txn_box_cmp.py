...
def test_txn_box_cmp(urtest: UraniumTest) -> None:
    # @file
    #
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    tr = urtest.TxnBoxTestAndRun("Test comparisons", "cmp.replay.yaml", config_path='Auto', config_key="meta.txn_box.global")
    ts = tr.Variables.TS
