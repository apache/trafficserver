...
def test_esi_request_size_cap(urtest: UraniumTest) -> None:
    '''
    ...
    tr = urtest.AddTestRun("Start the server and ATS.")
    ...
    tr = urtest.AddTestRun("Issue a request whose ESI include URL exceeds the 32 KB fetch cap.")
    tr.MakeCurlCommand(
