...
def test_esi_304(urtest: UraniumTest) -> None:
    '''
    ...
    '''
        ...
        def run_cases(self):
            ...
            tr = urtest.AddTestRun("First request for esi_etag.php: not cached")
            tr.MakeCurlCommand(
            ...
            tr = urtest.AddTestRun("Second request for esi_etag.php: will be cached")
            tr.MakeCurlCommand(
                'http://127.0.0.1:{0}/esi_etag.php -H"Host: www.example.com" '
