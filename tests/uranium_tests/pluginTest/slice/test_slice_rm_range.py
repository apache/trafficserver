...
def test_slice_rm_range(urtest: UraniumTest) -> None:
    '''
    ...
    class SliceStripRangeForHeadRequestTest:
        ...
        def __init__(self):
            ...
            self._server = urtest.MakeVerifierServerProcess("server", SliceStripRangeForHeadRequestTest.replay_file)
            self._configure_trafficserver()

        def _configure_trafficserver(self):
            """Configure Traffic Server."""
            self._ts = urtest.MakeATSProcess("ts", enable_cache=False)
        ...
        def _test_head_request_range_header(self):
            ...
            tr.AddVerifierClientProcess(
                "client", SliceStripRangeForHeadRequestTest.replay_file, http_ports=[self._ts.Variables.port])
