...
def test_slice_ident(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    tr = urtest.AddTestRun("Preload etag asset")
    ...
    tr = urtest.AddTestRun("Preload last-modified asset")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("Fetch etag asset")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("Fetch etag asset, custom")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("Fetch last-modified asset, custom")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("Fetch last-modified asset")
    ps = tr.Processes.Default
    ...
    tr = urtest.AddTestRun("Add 404 token to transaction log")
    ps = tr.Processes.Default
    ...
    urtest.AddAwaitFileContainsTestRun('Await ts transactions to finish logging.', tslog, '404.txt')
