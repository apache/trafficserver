...
def test_redirect_limit(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'A plugin re-setting the redirect URL each hop must not bypass number_of_redirections'
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'redirect_rearm.so'), ts)
