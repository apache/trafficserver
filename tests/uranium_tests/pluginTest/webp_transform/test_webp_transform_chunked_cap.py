...
def test_webp_transform_chunked_cap(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'webp_transform returns 502 for an over-cap chunked no-Content-Length response'
    ...
    tr = urtest.AddTestRun("over-cap chunked body is refused with a 502 and no body")
