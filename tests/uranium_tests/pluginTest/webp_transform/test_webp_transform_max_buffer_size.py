...
def test_webp_transform_max_buffer_size(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'max_buffer_size overrides the cap and rejects malformed values'
    ...
    tr = urtest.AddTestRun("2 MiB body declined at the 1 MiB override")
    tr.MakeCurlCommand(
    ...
    ts_bad = urtest.MakeATSProcess("ts_bad", enable_cache=False)
    ...
    tr_bad = urtest.AddTestRun("malformed max_buffer_size values are rejected, default retained")
