...
def test_ja3_fingerprint(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.SkipUnless(Condition.PluginExists('ja3_fingerprint.so'))
    ...
    class JA3FingerprintTest:
        ...
        def __init__(self, test_remap: bool, modify_incoming: bool) -> None:
            ...
            tr = urtest.AddTestRun(f'test_remap: {test_remap}, modify_incoming: {modify_incoming}')
        ...
        def _configure_server(self, tr: 'TestRun') -> None:
            ...
            if not self._test_remap:
                ...
                self._server.Streams.All += Testers.ContainsExpression(
                    "x-ja3-via: test.proxy.com", "The x-ja3-via string was added.")
        ...
        def _configure_trafficserver(self) -> None:
            ...
            self._ts = urtest.MakeATSProcess(name, enable_cache=False, enable_tls=True)
    ...
    """.split("\n"))
        ...
        def _await_ja3log(self) -> None:
            ...
            tr = urtest.AddTestRun('Await the contents of the JA3 log.')
        ...
        def _verify_internal_headers(self) -> None:
            ...
            tr = urtest.AddTestRun('Verify the internal client request headers.')
            ...
            tr = urtest.AddTestRun('Verify the internal proxy request headers.')
            p = tr.Processes.Default
