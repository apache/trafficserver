...
def test_traffic_dump_ip_filter(urtest: UraniumTest) -> None:
    """
    ...
    server = urtest.MakeVerifierServerProcess("server", "replay/traffic_dump_ip_filter_server.yaml")
    ...
    #
    tr = urtest.AddTestRun("Verify that -4 matches 127.0.0.1 as expected")
    ...
    #
    tr = urtest.AddTestRun("Verify that -4 filters out our non-matching IP as expected")
    ...
    #
    tr = urtest.AddTestRun("Verify that -4 detects an invalid IP string")
