...
def test_double_h2(urtest: UraniumTest) -> None:
    '''
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    #  or more contributor license agreements.  See the NOTICE file
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'continuations_verify.so'), ts)
    ...
    tr = urtest.AddTestRun("Check Ssn")
    ...
    tr = urtest.AddTestRun("Check Txn")
