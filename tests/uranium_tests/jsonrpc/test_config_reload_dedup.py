...
def test_config_reload_dedup(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.Summary = 'Verify trigger-record value change + file-mtime dedup during reload'
    ...
    # ============================================================================
    tr = urtest.AddTestRun("Change trigger record value in records.yaml via --cold")
    ...
    # ============================================================================
    tr = urtest.AddTestRun("Touch config files including sni.yaml")
