...
def test_parent_config_dest_ip(urtest: UraniumTest) -> None:
    '''
    ...
    tr = urtest.AddTestRun("request")
    ps = tr.Processes.Default
    tr.MakeCurlCommand(curl_and_args + ' http://foo.bar/foo.txt', ts=ts0)
    ps.ReturnCode = 0
