...
def test_tls_hooks8(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-cert=2')

    tr = urtest.AddTestRun("Test two cert hooks")
    ...
    ts.Disk.traffic_out.Content = "gold/ts-cert-2.gold"
