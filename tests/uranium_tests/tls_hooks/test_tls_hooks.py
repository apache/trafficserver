...
def test_tls_hooks(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-preaccept=1')

    tr = urtest.AddTestRun("Test one preaccept hook")
