...
def test_tls_hooks_close_while_parked(urtest: UraniumTest) -> None:
    '''
    ...
    tr = urtest.AddTestRun("Client disconnects while parked in the client hello hook")
    ...
    ts.Disk.traffic_out.Content = Testers.ContainsExpression(
        "Client Hello callback 0", "the handshake parked in the client hello hook")
