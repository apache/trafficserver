...
def test_tls_hooks17(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-client_hello=1 -close=1')

    tr = urtest.AddTestRun("Test one delayed client hello hook")
