...
def test_tls_hooks9(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-i=1')

    tr = urtest.AddTestRun("Test one immediate cert hooks")
    ...
    ts.Disk.traffic_out.Content = "gold/ts-cert-im-1.gold"
