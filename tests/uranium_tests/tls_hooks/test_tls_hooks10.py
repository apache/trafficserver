...
def test_tls_hooks10(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-cert=1 -i=2')

    tr = urtest.AddTestRun("Test a combination of delayed and immediate cert hooks")
