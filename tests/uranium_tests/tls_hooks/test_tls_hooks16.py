...
def test_tls_hooks16(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-client_hello_imm=1')

    tr = urtest.AddTestRun("Test one immediate client hello hook")
