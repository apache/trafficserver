...
def test_tls_hooks12(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-p=2 -d=1')

    tr = urtest.AddTestRun("Test combination of delayed and immediate preaccept hook2")
