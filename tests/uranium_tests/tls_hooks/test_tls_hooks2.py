...
def test_tls_hooks2(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-sni=1')

    tr = urtest.AddTestRun("Test one sni hook")
