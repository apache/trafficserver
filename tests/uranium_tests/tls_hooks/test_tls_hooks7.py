...
def test_tls_hooks7(urtest: UraniumTest) -> None:
    '''
    Test two SNI hooks
    '''
    #  Licensed to the Apache Software Foundation (ASF) under one
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-sni=2')

    tr = urtest.AddTestRun("Test two sni hooks")
