...
def test_tls_hooks18(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-client_hello=2 -close=1')

    tr = urtest.AddTestRun("Test two client hello hooks")
