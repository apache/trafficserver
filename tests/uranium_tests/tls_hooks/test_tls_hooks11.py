...
def test_tls_hooks11(urtest: UraniumTest) -> None:
    '''
    ...
    urtest.PrepareTestPlugin(os.path.join(urtest.Variables.AtsTestPluginsDir, 'ssl_hook_test.so'), ts, '-d=1')

    tr = urtest.AddTestRun("Test one delayed preaccept hook")
    ...
    ts.Disk.traffic_out.Content = "gold/ts-preaccept-delayed-1.gold"
