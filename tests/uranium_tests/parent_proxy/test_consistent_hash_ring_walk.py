...
def test_consistent_hash_ring_walk(urtest: UraniumTest) -> None:
    """
    ...
    class ParentDownRingWalkTest:
        ...
        def run(self):
            ...
            down = urtest.AddTestRun('Mark the entire parent pool down via HostStatus')
            ...
            load = urtest.AddTestRun('Request through the all-down pool -> bounded selection -> 502')
