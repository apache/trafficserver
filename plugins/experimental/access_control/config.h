...
public:
  ...
  bool loadMultiPatternsFromFile(const String &filename, bool blocklist = true);
  ...
  Classifier _uriPathScope; /**< @brief blocklist (exclude) and allow-list (include) which path should have the access control */
};
