...
public:
   ...
   * @return indicates whether parsing succeeded or not.
   */
  static bool getCustomSection(std::string_view bytecode, std::string_view name, std::string_view &ret);
   ...
   * @return indicates whether parsing succeeded or not.
   */
  static bool getFunctionNameIndex(std::string_view bytecode, std::unordered_map<uint32_t, std::string> &ret);
