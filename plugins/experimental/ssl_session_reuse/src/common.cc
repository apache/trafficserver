                 ...
                 size_t out_data_size, size_t *out_data_len)
{
  ...
  Dbg(dbg_ctl, "Encrypted buffer of size %d to buffer of size %lu.", in_data_len, *out_data_len);
  ret = 0;
                 ...
                 size_t out_data_size, size_t *out_data_len)
{
  ...
  *out_data_len = decrypted_len + decrypted_len_extra;
  ...
  Dbg(dbg_ctl, "Decrypted buffer of size %d to buffer of size %lu.", in_data_len, *out_data_len);
  ret = 0;
