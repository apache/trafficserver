...
struct TrackerStats {
  ...
  int events_untracked{-1}; ///< Events lost in an ordinary contest or bounded scan
  int scan_exhausted{-1};   ///< Events not tracked because the protected-slot scan hit its bound
