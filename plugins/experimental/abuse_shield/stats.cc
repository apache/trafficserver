...
TrackerStats::init(const char *prefix)
{
  ...
  events_untracked =
    TSStatCreate((base + "events_untracked").c_str(), TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_COUNT);
  scan_exhausted =
    TSStatCreate((base + "scan_exhausted").c_str(), TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_COUNT);
...
ActionStats::init()
{
  ...
  actions_block_failed =
    TSStatCreate("abuse_shield.actions.block_failed", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_COUNT);
  actions_closed = TSStatCreate("abuse_shield.actions.closed", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_COUNT);
  actions_close_failed =
    TSStatCreate("abuse_shield.actions.close_failed", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_COUNT);
  ...
  connections_reject_failed =
    TSStatCreate("abuse_shield.connections.reject_failed", TS_RECORDDATATYPE_INT, TS_STAT_NON_PERSISTENT, TS_STAT_SYNC_COUNT);
  fingerprint_matches =
