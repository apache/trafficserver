...
ts_lua_server_response_set_status(lua_State *L)
{
  ...
  TSHttpHdrStatusSet(http_ctx->server_response_bufp, http_ctx->server_response_hdrp, TSHttpStatus(status), "lua");
...
ts_lua_server_response_is_cacheable(lua_State *L)
{
  ...
  lua_pushnumber(L, TSHttpTxnIsCacheable(http_ctx->txnp, nullptr, http_ctx->server_response_bufp));
