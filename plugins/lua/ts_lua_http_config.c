...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_TRANSACTION_NO_ACTIVITY_TIMEOUT_OUT_MS   = TS_CONFIG_HTTP_TRANSACTION_NO_ACTIVITY_TIMEOUT_OUT_MS,
  TS_LUA_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT           = TS_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT,
  TS_LUA_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT_MS        = TS_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT_MS,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_TRANSACTION_NO_ACTIVITY_TIMEOUT_OUT_MS),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT_MS),
...
ts_lua_http_timeout_set(lua_State *L)
{
  ...
  case TS_LUA_TIMEOUT_ACTIVE:
    ...
    TSHttpTxnConfigIntSet(http_ctx->txnp, TS_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT_MS, value);
    break;

  case TS_LUA_TIMEOUT_CONNECT:
    TSDebug(TS_LUA_DEBUG_TAG, "setting connect timeout");
    TSHttpTxnConfigIntSet(http_ctx->txnp, TS_CONFIG_HTTP_POST_CONNECT_ATTEMPTS_TIMEOUT_MS, value);
    TSHttpTxnConfigIntSet(http_ctx->txnp, TS_CONFIG_HTTP_CONNECT_ATTEMPTS_TIMEOUT_MS, value);
    TSHttpTxnConfigIntSet(http_ctx->txnp, TS_CONFIG_HTTP_PARENT_CONNECT_ATTEMPT_TIMEOUT_MS, value);
    break;
  ...
  case TS_LUA_TIMEOUT_NO_ACTIVITY:
    ...
    TSHttpTxnConfigIntSet(http_ctx->txnp, TS_CONFIG_HTTP_TRANSACTION_NO_ACTIVITY_TIMEOUT_OUT_MS, value);
    break;
