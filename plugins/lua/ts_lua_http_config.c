...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_DOWN_SERVER_ABORT_THRESHOLD_DEPRECATED   = TS_CONFIG_HTTP_DOWN_SERVER_ABORT_THRESHOLD_DEPRECATED,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_DOWN_SERVER_ABORT_THRESHOLD_DEPRECATED),
