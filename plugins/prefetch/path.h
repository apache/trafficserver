 ...
 *
 * The prefetch plugin accepts query and CMCD metadata as instructions to fetch
 * a sibling object relative to the triggering object. Without this boundary
 ...
 * prefetch.
 * @param[in] relativePath The query or CMCD supplied path to fetch relative to
 * @a currentPath.
